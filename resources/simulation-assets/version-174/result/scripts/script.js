...
rabbit.util={parseBoolean:function(_1c4){
return _1c4===true||(_.isString(_1c4)&&_1c4.toLowerCase()==="true");
},bind:function(_1c5,_1c6){
return function(){
try{
return _1c5.apply(_1c6,arguments);
}
catch(e){
console.error(e);
}
...
name=name.replace(/[\[\]]/g,"\\$&");
var _1c7=new RegExp("[?&]"+name+"(=([^&#]*)|&|#|$)"),_1c8=_1c7.exec(url);
if(!_1c8){
return null;
}
if(!_1c8[2]){
...
return decodeURIComponent(_1c8[2].replace(/\+/g," "));
},bindSingleAndDoubleClick:function(_1c9,_1ca,_1cb,_1cc,_1cd){
_1cd=_1cd||500;
$(_1c9).click(function(_1ce){
...
}).dblclick(function(_1cf){
clearTimeout($(this).data("timer"));
$(this).data("timer",null);
return _1cb(_1cf);
});
},bindInput:function(_1d0,_1d1,_1d2,_1d3){
if(_1d3===undefined){
_1d3=_1d1;
}
Mousetrap(_1d0).bind("enter",_1d1);
Mousetrap(_1d0).bind(["escape","esc"],_1d2,"keyup");
if(_1d3){
$(_1d0).blur(function(_1d4){
_1d3(_1d4);
});
}
},emptyNode:function(node){
var _1d5=this.getChildren(node);
for(var i=_1d5.length-1;i>=0;i--){
node.removeChild(_1d5[i]);
}
...
var _1d6=node.childNodes;
var _1d7=[];
for(var i=0;i<_1d6.length;i++){
if(_1d6[i].nodeType===Node.ELEMENT_NODE){
_1d7.push(_1d6[i]);
}
}
return _1d7;
}
},scrollToRelative:function(_1d8,_1d9,_1da){
var to=_1d8.scrollTop+_1d9;
this.scrollTo(_1d8,to,_1da);
},scrollTo:function(_1db,to,_1dc){
$(_1db).animate({scrollTop:to},_1dc);
},xmlEncode:function(_1dd){
return _1dd.toString().replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/"/g,"&quot;");
},xmlDecode:function(_1de){
return _1de.toString().replace(/&quot;/g,"\"").replace(/&lt;/g,"<").replace(/&amp;/g,"&");
},convertDate:function(_1df){
if(_1df=="7000000000000"){
return "not yet saved";
}
return Ext.util.Format.date(new Date(parseInt(_1df)),"Y-m-d G:i");
},appendVersionQuery:function(_1e0){
return _1e0+"?v="+rabbit.parameters.codeVersion;
},cloneObject:function(_1e1){
return JSON.parse(JSON.stringify(_1e1));
},Class:function(_1e2,_1e3){
if(!_1e3){
_1e3=_1e2;
_1e2=function(){
};
...
this.parent=_1e2.prototype;
this.init.apply(this,arguments);
}
};
_1e3.call(F.prototype=new _1e2(rabbit.util.Class),_1e2.prototype);
return F;
},absoluteCenter:function(_1e4){
var left=$(_1e4).parent().width()/2-$(_1e4).width()/2;
var top=$(_1e4).parent().height()/2-$(_1e4).height()/2;
$(_1e4).css({left:left,top:top,position:"absolute"});
},getResolvedPromise:function(){
var _1e5=new jQuery.Deferred();
_1e5.resolve();
return _1e5.promise();
},addClass:function(_1e6,_1e7){
if(typeof _1e6==="string"){
_1e6=document.getElementById(_1e6);
}
_1e6.setAttribute("class",_1e6.getAttribute("class")+" "+_1e7);
},removeClass:function(_1e8,_1e9){
if(typeof _1e8==="string"){
_1e8=document.getElementById(_1e8);
}
_1e8.setAttribute("class",_1e8.getAttribute("class").replace(_1e9,""));
...
return 1;
},insertAtIndex:function(_1ea,key,_1eb,_1ec){
var tmp={};
var keys=_.keys(_1ea);
for(var i=0;i<keys.length;i++){
if(i>=_1ec){
tmp[keys[i]]=_1ea[keys[i]];
delete _1ea[keys[i]];
}
}
_1ea[key]=_1eb;
...
var _1ed=this.getChildren(node);
for(var i=0;i<_1ed.length;i++){
this.recursivelyRemoveId(_1ed[i]);
}
},getScrollbarWidth:function(){
if(this.scrollbarWidth){
return this.scrollbarWidth;
}
var _1ee=document.createElement("div");
_1ee.style.visibility="hidden";
_1ee.style.width="100px";
_1ee.style.msOverflowStyle="scrollbar";
document.body.appendChild(_1ee);
var _1ef=_1ee.offsetWidth;
_1ee.style.overflow="scroll";
var _1f0=document.createElement("div");
_1f0.style.width="100%";
_1ee.appendChild(_1f0);
var _1f1=_1f0.offsetWidth;
_1ee.parentNode.removeChild(_1ee);
this.scrollbarWidth=_1ef-_1f1;
return this.scrollbarWidth;
}};
...
console.error=function(e,_1f2){
var line=(e.lineNumber!=null)?e.lineNumber:e.line;
var file=(e.fileName!=null)?e.fileName:e.sourceURL;
var data={"errorJSON":JSON.stringify(e),"message":((_1f2)?"From window.onerror ":"")+e.name+": "+e.message,"url":file,"line":line,"stack":e.stack};
...
window.onerror=function(_1f3,url,_1f4,_1f5,_1f6){
if(_1f6){
console.error(_1f6,true);
}else{
var data={"errorJSON":{},"message":"From window.onerror "+_1f3,"url":url,"line":_1f4,"stack":""};
rabbit.communication.manager.submitError(data);
if(document.URL.match(/http:\/\/localhost:.*/)||document.URL.match(/http(s)?:\/\/[^\/]*stage\.pidoco\.com.*/)){
console.oldError(null,arguments);
}
...
rabbit.facade={registerUserPref:function(key,_1f7){
rabbit.common.prefsManager.registerUserPref(key,_1f7);
},setUserPref:function(key,_1f8){
rabbit.common.prefsManager.setUserPref(key,_1f8);
},getUserPref:function(key){
return rabbit.common.prefsManager.getUserPref(key);
},setFrameSpecificUserPref:function(_1f9,_1fa,key,_1fb){
var _1fc=rabbit.util.cloneObject(rabbit.facade.getUserPref(key));
_1fc[_1f9]=_1fc[_1f9]||{};
_1fc[_1f9][_1fa]=_1fb;
rabbit.facade.setUserPref(key,_1fc);
},getFrameSpecificUserPref:function(_1fd,_1fe,key){
var _1ff=rabbit.facade.getUserPref(key);
if(_1ff[_1fd]&&_1ff[_1fd][_1fe]){
return _1ff[_1fd][_1fe];
}else{
return null;
}
},registerPrototypePref:function(key,_200){
rabbit.common.prefsManager.registerPrototypePref(key,_200);
},setPrototypePref:function(key,_201){
rabbit.common.prefsManager.setPrototypePref(key,_201);
},getPrototypePref:function(key){
return rabbit.common.prefsManager.getPrototypePref(key);
},setFrameSpecificPrototypePref:function(_202,_203,key,_204){
var _205=rabbit.util.cloneObject(rabbit.facade.getPrototypePref(key));
_205[_202]=_205[_202]||{};
_205[_202][_203]=_204;
rabbit.facade.setPrototypePref(key,_205);
},getFrameSpecificPrototypePref:function(_206,_207,key){
var _208=rabbit.facade.getPrototypePref(key);
if(_208[_206]&&_208[_206][_207]){
return _208[_206][_207];
}else{
return null;
}
},sendMessage:function(url,data,_209){
if(rabbit.communication&&rabbit.communication.manager&&rabbit.communication.manager.sendMessage){
rabbit.communication.manager.sendMessage(url,data,_209);
}
}};
rabbit.result={};
rabbit.ui={};
...
rabbit.plugins={};
rabbit.stencils={};
rabbit.util=_.extend(rabbit.util,{formatDate:function(_20a){
var diff=((new Date()).getTime()-_20a)/1000/60;
var date=new Date(_20a);
if(diff<2){
...
},isElementChildOfSelector:function(_20b,_20c){
return $(_20b).parents(_20c).length>0;
},userRole:null});
...
var _20d={};
var _20e={};
return {registerOnEvent:function registerOnEvent(_20f,_210,_211,_212){
if(typeof _20f!=="string"||typeof _210!=="function"||typeof _211!=="object"){
throw "Invalid Arguments for registerOnEvent";
}
if(!_20d.hasOwnProperty(_20f)){
_20d[_20f]=[];
}
var data={"callback":_210,"thisArg":_211,"includeEventType":false};
if(_212){
data.includeEventType=true;
}
_20d[_20f].push(data);
},registerOnCategoryEvent:function(_213,_214,_215){
if(typeof _213!=="string"||typeof _214!=="function"||typeof _215!=="object"){
throw "Invalid Arguments for registerOnEventForCategory";
}
if(!_20e.hasOwnProperty(_213)){
_20e[_213]=[];
}
var data={"callback":_214,"thisArg":_215,"includeEventType":true};
_20e[_213].push(data);
console.log("ok for "+_213);
},raiseEvent:function raiseEvent(_216){
this._raiseCategoryEvent.apply(this,arguments);
this._raiseNormalEvent.apply(this,arguments);
},_raiseCategoryEvent:function raiseEvent(_217){
var _218=_217.replace(/\..*$/,"");
if(_218!=_217){
console.log("Try to raise catergory "+_218);
var _219=_20e[_218];
if(typeof _219==="undefined"){
console.warn("No handler category for invoked eventType "+_217+" (category: "+_218+")");
return;
}
for(var i=0;i<_219.length;i++){
try{
var args=Array.prototype.slice.call(arguments);
this._raiseEvent(_219[i],args);
}
catch(e){
console.error(e);
}
...
},_raiseNormalEvent:function raiseEvent(_21a){
var _21b=_20d[_21a];
if(typeof _21b==="undefined"){
console.warn("No handler for invoked eventType "+_21a);
return;
}
for(var i=0;i<_21b.length;i++){
try{
var args=Array.prototype.slice.call(arguments);
this._raiseEvent(_21b[i],args);
}
catch(e){
console.error(e);
}
}
},_raiseEvent:function(_21c,args){
var _21d=_21c.callback;
var _21e=_21c.thisArg;
var _21f=_21c.includeEventType;
...
},buildEditUrl:function(_220){
var _221="/rabbit/edit/"+rabbit.result.manager.currentPrototypeId+"#";
var _222="page/"+rabbit.result.manager.currentPageNr;
var _223="";
if(_220){
var page=rabbit.data.pageStore.objects[_220];
var _224=rabbit.data.folderStore.objects[page.data.parentFolder];
while(_224!==undefined){
_223="folder/"+_224.data.id+"/"+_223;
_224=rabbit.data.folderStore.objects[_224.data.parentFolder];
}
}
return _221+_223+_222;
},getUrl:function(name,_225){
var url=this.urls[name];
var _226=rabbit.result.manager.urlPattern;
...
if(name==="loadLayer"){
_226=rabbit.result.manager.urlPattern.replace("__page__","layer/__page__");
}
url=url.replace("__urlPattern__",_226);
if(_225){
for(var key in _225){
url=url.replace("__"+key+"__",_225[key]);
}
}
return url;
},sendMessage:function(url,data,_227){
this.post(rabbit.common.baseUrl+url,undefined,data,{complete:_227});
},get:function(url,_228,data,_229){
return this.ajax(url,"get",_228,data,_229);
},post:function(url,_22a,data,_22b){
return this.ajax(url,"post",_22a,data,_22b);
},ajax:function(url,type,_22c,data,_22d){
if(!url){
...
data=data||undefined;
_22d=_22d||{};
var _22e=_.defaults({url:url,type:type,dataType:_22c,data:data},_22d);
return $.ajax(_22e);
}};
rabbit.result.manager={datePickerClicked:false,customDatepickerObjects:[],init:function(_22f,_230,_231,_232){
try{
...
rabbit.prototypeType=_230;
rabbit.browser=_231;
this.initialPageId=_22f;
...
},pageReady:function(_233){
var page=rabbit.data.pageStore.objects[_233];
...
try{
var _234=rabbit.facade._availablePlugins[i];
_234.init.apply(_234,_234._initialArguments);
}
catch(e){
console.error(e);
}
...
},goToPage:function(_235,_236){
var url;
var page=rabbit.data.pageStore.objects[_235];
var _237=Boolean(_235.match(/^[a-zA-Z0-9]*$/));
if(_237){
url=rabbit.data.pageStore.getPageUrl(_235);
...
if(!_235.match(/^[a-zA-Z0-9]*:\/\//)){
url="http://"+_235;
}else{
url=_235;
}
}
if(!_237&&rabbit.facade.runningInApp()&&rabbit.facade.isIOS){
...
},showPage:function(_238,_239,_23a,_23b){
_23a=_23a||false;
var _23c=_238.attr("id");
try{
if(_239===""||_239===this.currentPageNr){
return;
}
var page=rabbit.data.pageStore.objects[_239];
console.log("show page repository:"+_23c+" page:"+_239,page);
if(page===undefined){
this.goToPage(_239);
return;
}
rabbit.ui.manager.showPage(_238,_239,_23b);
if(_23a===true&&this.isPushStateAvailable){
console.log("PUSH STATE",_239);
window.history.pushState({repositoryId:_23c,pageId:_239},"",rabbit.data.pageStore.getPageUrl(_239));
}
this.currentPageNr=_239;
_238.data("page-id",_239);
rabbit.event.manager.raiseEvent(rabbit.events.pageLoaded,page,_238);
rabbit.mobile.trigger("pidoco:afterShowPage");
}
catch(e){
console.error(e);
}
},menuClick:function(a,b,_23d){
rabbit.result.manager.goToPage(_23d,false);
}};
...
},createWrappers:function(_23e,_23f,_240){
var _241=_23e.find(">.wrapper.wrapper-"+_23f);
if(!_241.length){
_241=$("<div data-layer-id=\""+_23f+"\" id=\""+_23e[0].id+"-"+_23f+"-wrapper\" class=\"wrapper wrapper-"+_23f+"\" style=\"display: none\"></div>").appendTo(_23e);
}
var page=rabbit.data.pageStore.objects[_23f];
if(_240===true&&page){
for(var name in page.data.layers){
if(page.data.layers[name]===true||page.data.layers[name]==="true"){
this.createWrappers(_23e,name);
}
}
}
return _241;
},fillWrappersWithLayer:function(_242){
var _243=_242.data.id;
$(".wrapper-"+_243+"[data-fill-me=\"true\"]:empty").each(function(_244,_245){
this.fillWrapperWithLayer(_245,_242);
_245.removeAttribute("data-fill-me");
}.bind(this));
},fillWrapperWithLayer:function(_246,_247,_248){
var _249=_246.parentNode.id;
var html=_247.data.html;
if(html){
html=$(_247.data.html.replace(/__containerId__/g,_249));
if(_248){
html.find("script").remove();
}
$(_246).append(html);
if(!this.inTransition){
rabbit.facade.raiseEvent(rabbit.events.layerStoreInserted,_246.children[0]);
}
}else{
_246.setAttribute("data-fill-me","true");
}
return html;
},getLayerWrapper:function(_24a,_24b){
return _24a.find(">.wrapper-"+_24b);
},showLayer:function(_24c,_24d){
var _24e=rabbit.data.layerStore.objects[_24d];
if(!_24e){
rabbit.data.layerStore.loadLayer(_24d);
_24e=rabbit.data.layerStore.objects[_24d];
}
var _24f=this.getLayerWrapper(_24c,_24d);
if(!_24f.length){
_24f=this.createWrappers(_24c,_24d,true);
}
if(_24f[0].children.length===0){
this.fillWrapperWithLayer(_24f[0],_24e);
}
_24f.show();
rabbit.event.manager.raiseEvent(rabbit.events.showLayer,{id:_24c.attr("id")+_24d,layerId:_24d,repositoryId:_24c.attr("id")});
},hideLayer:function(_250,_251){
var _252=this.getLayerWrapper(_250,_251);
_252.hide();
rabbit.event.manager.raiseEvent(rabbit.events.hideLayer,{id:_250.attr("id")+_251,layerId:_251,repositoryId:_250.attr("id")});
},toggleLayer:function(_253,_254){
var _255=this.getLayerWrapper(_253,_254);
if(!_255.length||_255.css("display")==="none"){
return this.showLayer(_253,_254);
}else{
return this.hideLayer(_253,_254);
}
},showPage:function(_256,_257,_258){
var _259;
if(_258==="fromRight"||_258==="fromLeft"||_258==="fromTop"||_258==="fromBottom"){
_259=this.showPageWithTranslation(_256,_257,_258);
}else{
if(_258==="opacity"){
_259=this.showPageWithOpacity(_256,_257);
}else{
if(_258==="flip"){
_259=this.showPageWithFlip(_256,_257);
}else{
_259=this.showPageWithoutTransition(_256,_257);
}
}
}
if(_256.attr("id")=="repository"&&_259){
_259.done(function(){
$(_256).attr("data-review-reference-id",_257);
$(_256).attr("data-page-id",_257);
$("body").attr("data-current-page-id",_257);
});
}
},showPageWithoutTransition:function(_25a,_25b){
var page=rabbit.data.pageStore.objects[_25b];
var _25c=new $.Deferred();
rabbit.ui.manager.showLayer(_25a,_25b);
_.each(page.data.layers,function(_25d,_25e){
this.showLayer(_25a,_25e);
}.bind(this));
_25a.find(">.wrapper").each(function(_25f,_260){
var _261=_260.getAttribute("data-layer-id");
if((!page.data.layers.hasOwnProperty(_261)||page.data.layers[_261]!==true)&&_261!=_25b){
this.hideLayer(_25a,_261);
}
}.bind(this));
_25c.resolve();
return _25c.promise();
},showPageWithFlip:function(_262,_263){
var _264=500;
var _265=new $.Deferred();
this.startTransition(_262);
var _266=this.createTransitionWrapper(_262,_263);
var _267=_266.leave.find(">div");
var _268=_266.enter.find(">div");
_262.find(">div").hide();
_262.append(_266.leave).append(_266.enter);
_268.hide();
_267.transition({perspective:"0px",rotateY:"90deg",duration:_264},function(){
_268.transition({perspective:"0px",rotate3d:"0,1,0,270deg",duration:0},function(){
_268.show();
this.showPageWithoutTransition(_268,_263);
_268.transition({perspective:"0px",rotate3d:"0,1,0,360deg",duration:_264},function(){
_267.transition({perspective:"0px",rotateY:"0deg",duration:0},function(){
this.stopTransition(_262);
this.showPageWithoutTransition(_262,_263);
_266.leave.remove();
_266.enter.remove();
_265.resolve();
}.bind(this));
...
return _265.promise();
},showPageWithOpacity:function(_269,_26a){
var _26b=500;
var _26c=new $.Deferred();
this.startTransition(_269);
var _26d=this.createTransitionWrapper(_269,_26a);
var _26e=_26d.leave.find(">div");
var _26f=_26d.enter.find(">div");
_269.find(">div").hide();
_269.append(_26d.leave).append(_26d.enter);
_26f.css({opacity:0});
_26e.transition({opacity:0,duration:_26b},function(){
this.showPageWithoutTransition(_26f,_26a);
_26f.transition({opacity:1,duration:_26b},function(){
this.stopTransition(_269);
this.showPageWithoutTransition(_269,_26a);
_26d.leave.remove();
_26d.enter.remove();
_26c.resolve();
}.bind(this));
...
return _26c.promise();
},showPageWithTranslation:function(_270,_271,_272){
var _273=_270.width();
var _274=_270.height();
var _275=500;
var _276=new $.Deferred();
this.startTransition(_270);
var _277=this.createTransitionWrapper(_270,_271);
var _278=_277.leave.find(">div");
var _279=_277.enter.find(">div");
if(_272==="fromLeft"){
_279.css("left",-1*_273);
}else{
if(_272==="fromTop"){
_279.css("top",-1*_274);
}else{
...
_279.find(">div").show();
_270.find(">div").hide();
_270.append(_277.leave).append(_277.enter);
var _27a=function(){
this.stopTransition(_270);
this.showPageWithoutTransition(_270,_271);
_277.leave.remove();
_277.enter.remove();
_276.resolve();
}.bind(this);
if(_272==="fromLeft"){
_278.transition({x:_273+"px",duration:_275});
_279.transition({x:_273+"px",duration:_275},_27a);
}else{
if(_272==="fromTop"){
_278.transition({y:_274+"px",duration:_275});
_279.transition({y:_274+"px",duration:_275},_27a);
}else{
if(_272==="fromBottom"){
_278.transition({y:"-"+_274+"px",duration:_275});
_279.transition({y:"-"+_274+"px",duration:_275},_27a);
...
return _276.promise();
},createTransitionWrapper:function(_27b,_27c){
var _27d=_27b.data("page-id");
var _27e=rabbit.data.pageStore.objects[_27c];
var _27f=rabbit.data.pageStore.objects[_27d];
var _280,_281;
var _282=$("<div class=\"transition-wrapper transition-enter\" data-page-id=\""+_27c+"\"><div class=\"layer-container\"></div></div>");
var _283=$("<div class=\"transition-wrapper transition-leave\" data-page-id=\""+_27d+"\"><div class=\"layer-container\"></div></div>");
var _284=_283.find(">div");
var _285=_282.find(">div");
var _286=_27b.find(".wrapper-"+_27d).clone().remove("script");
var _287=_27b.find(".wrapper-"+_27c).clone().remove("script");
for(_280 in _27e.data.layers){
_281=_27e.data.layers[_280];
if(_281===true||_281==="true"){
this.createWrappers(_285,_280,false);
this.showLayer(_285,_280);
}
}
for(_280 in _27f.data.layers){
_281=_27f.data.layers[_280];
if(_281===true||_281==="true"){
this.createWrappers(_284,_280,false);
this.showLayer(_284,_280);
}
}
_284.append(_286);
if(_287.length===0){
_287=this.createWrappers(_285,_27c,true);
}else{
_285.append(_287);
}
if(_287.children().length===0){
this.fillWrapperWithLayer(_287[0],rabbit.data.layerStore.objects[_27c],true);
}
return {enter:_282,leave:_283};
},startTransition:function(_288){
this.inTransition=true;
$("body").addClass("disable-pointer-events");
$(_288).addClass("during-transition");
},stopTransition:function(_289){
this.inTransition=false;
$("body").removeClass("disable-pointer-events");
$(_289).removeClass("during-transition");
},_forceRedraw:function(){
var _28a=navigator.userAgent.toLowerCase().indexOf("chrome")>-1;
var _28b=navigator.userAgent.toLowerCase().indexOf("safari")>-1;
if(_28a||_28b){
...
rabbit.interaction.manager={tmp:{},actions:{click:{makeableOnDesktop:function(_28c){
return !_28c.numberOfFinger||_28c.numberOfFinger=="1"||_28c.numberOfFinger=="any";
},render:function(_28d){
if(parseInt(_28d.data.action.numberOfFinger,10)>1){
return t("interaction.action.multiFingerClick.userDescription").replace("__element__",rabbit.interaction.manager.getElementTitle(_28d));
}else{
return t("interaction.action.click.userDescription").replace("__element__",rabbit.interaction.manager.getElementTitle(_28d));
}
},defineEvent:function(_28e){
var _28f=document.getElementById(_28e.data.stencilId);
if(_28e.data.action.button=="right"){
$(_28f).on("contextmenu",function(e){
rabbit.interaction.manager.raiseInteraction(_28e,rabbit.interaction.manager.serializeEvent(e));
return false;
});
}else{
if(false){
...
var _292=200;
var _293=500;
_28f.addEventListener("touchstart",function(e){
if(!_28e.data.action.numberOfFinger||(_28e.data.action.numberOfFinger&&(_28e.data.action.numberOfFinger==="any"||parseInt(_28e.data.action.numberOfFinger,10)===e.touches.length))){
_290=new Date().getTime();
}
e.preventDefault();
},false);
_28f.addEventListener("touchend",function(e){
if(_290){
...
if(rabbit.interaction.manager.actions.click.makeableOnDesktop(_28e.data.action)){
_28f.addEventListener("click",function(e){
rabbit.interaction.manager.raiseInteraction(_28e,rabbit.interaction.manager.serializeEvent(e));
});
}
}
}
}},doubleClick:{makeableOnDesktop:true,render:function(_294){
return t("interaction.action.doubleClick.userDescription").replace("__element__",rabbit.interaction.manager.getElementTitle(_294));
},defineEvent:function(_295){
var _296=document.getElementById(_295.data.stencilId);
if(_295.data.action.button=="right"){
$(_296).on("contextmenu",function(e){
rabbit.interaction.manager.raiseInteraction(_295,rabbit.interaction.manager.serializeEvent(e));
return false;
});
}else{
if(false){
...
var _299=200;
var _29a=500;
_296.addEventListener("touchstart",function(e){
_297=new Date().getTime();
if(_29a<(_297-_298)){
_298=null;
}
e.preventDefault();
},false);
_296.addEventListener("touchend",function(e){
if(_297){
var end=new Date().getTime();
if(_299>(end-_297)){
if(!_298){
...
_296.addEventListener("dblclick",function(e){
rabbit.interaction.manager.raiseInteraction(_295,rabbit.interaction.manager.serializeEvent(e));
});
}
}
}},hover:{makeableOnDesktop:true,render:function(_29b){
return t("interaction.action.hover.userDescription").replace("__element__",rabbit.interaction.manager.getElementTitle(_29b));
},defineEvent:function(_29c){
if(!_29c.data.action.trigger){
_29c.data.action.trigger="enter";
}
if(_29c.data.action.trigger=="both"||_29c.data.action.trigger=="enter"){
$("#"+_29c.data.stencilId).on("mouseenter",function(e){
rabbit.interaction.manager.raiseInteraction(_29c,rabbit.interaction.manager.serializeEvent(e));
});
}
if(_29c.data.action.trigger=="both"||_29c.data.action.trigger=="leave"){
$("#"+_29c.data.stencilId).on("mouseleave",function(e){
rabbit.interaction.manager.raiseInteraction(_29c,rabbit.interaction.manager.serializeEvent(e));
});
}
}},swipe:{makeableOnDesktop:false,render:function(_29d){
return t("interaction.action.swipe.userDescription").replace("__element__",rabbit.interaction.manager.getElementTitle(_29d));
},defineEvent:function(_29e){
var _29f=Hammer(document.getElementById(_29e.data.stencilId),{swipe_max_touches:5,drag_block_horizontal:true,drag_block_vertical:true,swipe_velocity:0.4});
_29f.on("swipe",function(e){
if(_29e.data.action.direction==="any"||e.gesture.direction===_29e.data.action.direction){
rabbit.facade.markHighlightTouchesAsSuccessful();
rabbit.interaction.manager.raiseInteraction(_29e,rabbit.interaction.manager.serializeEvent(e));
}
});
}},pinch:{makeableOnDesktop:false,render:function(_2a0){
return t("interaction.action.pinch.userDescription").replace("__element__",rabbit.interaction.manager.getElementTitle(_2a0));
},defineEvent:function(_2a1){
var _2a2=Hammer(document.getElementById(_2a1.data.stencilId),{prevent_default:true});
var _2a3=null;
var _2a4=false;
if(_2a1.data.action.direction==="in"){
_2a3="pinchin";
}else{
if(_2a1.data.action.direction==="out"){
_2a3="pinchout";
}else{
_2a3="pinch";
}
}
_2a2.on("transformstart",function(e){
_2a4=false;
});
_2a2.on("transformend",function(e){
if(_2a4){
rabbit.facade.markHighlightTouchesAsSuccessful();
rabbit.interaction.manager.raiseInteraction(_2a1,rabbit.interaction.manager.serializeEvent(e));
}
});
_2a2.on(_2a3,function(e){
_2a4=true;
});
}}},getInterinteractionEventId:function(_2a5){
return "interaction."+_2a5;
},raiseInteraction:function(_2a6,e){
if(this.isInteractionExecutable(_2a6)){
rabbit.facade.raiseEvent(_2a6.data.uniqueId,e);
return true;
}else{
return false;
}
},isLayerHidden:function(_2a7){
return $(_2a7).css("display")==="none";
},isInteractionExecutable:function(_2a8){
var _2a9=$("#"+_2a8.data.stencilId);
var _2aa=_2a9.parents(".layer");
for(var i=0;i<_2aa.length;i++){
if(this.isLayerHidden(_2aa.get(i))){
return false;
}
}
if(_2a9.length===0||_2a9.hasClass("layer")&&this.isLayerHidden(_2a9)){
return false;
}
return true;
},renderAction:function(_2ab){
return rabbit.interaction.manager.actions[_2ab.data.action.type].render(_2ab);
},getElementTitle:function(_2ac){
var type=$("#"+_2ac.data.stencilId).data("interactive-element-type");
return t("stencils."+type+"-palette");
},registerAction:function(name,_2ad){
if(_.has(rabbit.interaction.manager.actions,name)){
throw "Action with name "+name+" already exists.";
}else{
rabbit.interaction.manager.actions[name]=_2ad;
}
},registerReaction:function(name,_2ae){
if(_.has(rabbit.interaction.manager.reactions,name)){
throw "Action with name "+name+" already exists.";
}else{
rabbit.interaction.manager.reactions[name]=_2ae;
}
},reactions:{showPage:{init:function(_2af,_2b0){
var _2b1=rabbit.interaction.manager.reactions.showPage.getOpeningMethod(_2b0);
if(_2b1==="withoutReloadOnly"||_2b1==="withoutReloadIframe"){
rabbit.facade.loadLayer(_2b0.target);
}
},getOpeningMethod:function(_2b2){
var _2b3=_2b2.options;
if(!_2b3){
if(_2b2.inNewTab==="true"){
_2b3="reloadNewTab";
}else{
if(_2b2.withoutReload=="true"){
_2b3="withoutReloadOnly";
}else{
if(_2b2.withoutReload!==undefined){
_2b3="reloadOnly";
}
}
}
...
return _2b3;
},callback:function(_2b4,_2b5,_2b6){
var _2b7=_2b6.target;
if(!_2b7){
return;
}
var _2b8=rabbit.interaction.manager.reactions.showPage.getOpeningMethod(_2b6);
if(_2b8==="reloadNewTab"){
rabbit.result.manager.goToPage(_2b7,true);
}else{
if(_2b8==="withoutReloadOnly"){
rabbit.facade.showPage($("#repository"),_2b7,true,_2b6.transition);
}else{
if(_2b8==="withoutReloadIframe"){
var _2b9=document.getElementById(_2b5.data.stencilId);
var _2ba=rabbit.facade.getRepositoryFromStencil(_2b9);
var _2bb=false;
if(_2ba.attr("id")==="repository"){
_2bb=true;
}
rabbit.facade.showPage(_2ba,_2b7,_2bb,_2b6.transition);
}else{
rabbit.result.manager.goToPage(_2b7);
}
}
}
}},toggleLayer:{init:function(_2bc,_2bd){
rabbit.facade.loadLayer(_2bd.layer);
},callback:function(_2be,_2bf,_2c0){
var _2c1=document.getElementById(_2bf.data.stencilId);
var _2c2=rabbit.facade.getRepositoryFromStencil(_2c1);
if(_2c0.visibility==="toggle"){
rabbit.facade.toggleLayer(_2c2,_2c0.layer);
}else{
if(_2c0.visibility==="show"){
rabbit.facade.showLayer(_2c2,_2c0.layer);
}else{
if(_2c0.visibility==="hide"){
rabbit.facade.hideLayer(_2c2,_2c0.layer);
}
}
}
}},vibrate:{callback:function(_2c3,_2c4,_2c5){
navigator.vibrate=navigator.vibrate||navigator.mozVibrate||navigator.webkitVibrate||undefined;
if(navigator.vibrate){
navigator.vibrate(_2c5.duration);
}else{
if(window.parentBody){
window.parentBody.trigger("pidoco:vibrate",[{duration:_2c5.duration}]);
}else{
}
}
}},browserBack:{callback:function(_2c6,_2c7,_2c8){
rabbit.facade.browserBack();
}},browserForward:{callback:function(_2c9,_2ca,_2cb){
rabbit.facade.browserForward();
}},closeBrowserWindow:{callback:function(_2cc,_2cd,_2ce){
rabbit.facade.closeBrowserWindow();
}}},registerInteraction:function(_2cf,_2d0,_2d1,_2d2){
if(_2cf[0]==="-"){
return;
}
if(!_.isArray(_2d2)){
...
var _2d3=new rabbit.data.Interaction(_2cf,_2d0,_2d1,_2d2);
_2d3.initializeAction();
_2d3.initializeReactions();
rabbit.facade.raiseEvent(rabbit.events.newInteractionRegistered,_2d3);
},serializeEvent:function(e){
return {};
}};
rabbit.mobile={bind:function(_2d4,_2d5){
if(rabbit.facade.runningInApp()){
document.addEventListener(_2d4,_2d5);
}
},unbind:function(_2d6,_2d7){
if(rabbit.facade.runningInApp()){
document.removeEventListener(_2d6,_2d7);
}
},trigger:function(_2d8,data){
if(rabbit.facade.runningInApp()){
window.parentBody.trigger(_2d8,data);
}
}};
rabbit.facade=_.extend(rabbit.facade,function _returnFacade(){
var _2d9=rabbit.event.manager;
return {_availablePlugins:[],vml:false,isIOS:navigator.userAgent.match(/iPad|iPhone/),isAndroid:navigator.userAgent.match(/Android/),scaleFactor:1,registerPlugin:function registerPlugin(_2da,_2db){
try{
var _2dc=Array.prototype.slice.call(arguments);
_2dc.shift();
_2da._initialArguments=_2dc;
this._availablePlugins.push(_2da);
}
catch(e){
console.log(e);
}
},setScaleFactor:function(_2dd){
this.scaleFactor=_2dd;
},getScaleFactor:function(){
return this.scaleFactor;
},isFrameDisplayed:false,registerOnEvent:function registerOnEvent(_2de,_2df,_2e0){
try{
if(_.isArray(_2de)){
for(var i=0;i<_2de.length;i++){
console.debug("Registering a handler for "+_2de[i]);
_2d9.registerOnEvent(_2de[i],_2df,_2e0,true);
}
}else{
if(_.isString(_2de)){
console.debug("Registering a handler for "+arguments[0]);
_2d9.registerOnEvent(_2de,_2df,_2e0,false);
}
}
}
catch(e){
...
},registerOnCategoryEvent:function(_2e1,_2e2,_2e3){
try{
_2d9.registerOnCategoryEvent(_2e1,_2e2,_2e3,true);
}
catch(e){
console.error(e);
return undefined;
}
},raiseEvent:function raiseEvent(_2e4){
console.debug("Raising a "+arguments[0]+" event");
try{
return _2d9.raiseEvent.apply(_2d9,arguments);
}
catch(e){
console.error(e);
return undefined;
}
},fireMouseOn:function fireMouseOn(_2e5){
var _2e6=document.getElementById(_2e5);
if(_2e6===null){
return;
}
console.debug("Forwarding a click event to "+_2e5);
_2e6.click();
_2e6.focus();
},showPage:function(){
...
window.close();
},getLayerFromStencil:function(_2e8){
return $(_2e8).closest(".layer");
},getRepositoryFromStencil:function(_2e9){
return $(_2e9).closest(".repository");
},isExport:function(){
...
},"alert":function(_2ed,text,_2ee){
rabbit.plugins.systemAlert.alert(_2ed,text,_2ee);
}};
}());
...
},loadLayer:function(_2ef){
var ajax;
if(typeof this.objects[_2ef]==="undefined"){
var url=null;
if(rabbit.result.manager.isExport){
var _2f0=(rabbit.browser==="ie")?"-ie":"";
url=rabbit.communication.manager.getUrl("loadLayerExport",{layerId:_2ef,browser:_2f0,mode:rabbit.util.getMode()});
}else{
url=rabbit.communication.manager.getUrl("loadLayer",{prototypeId:rabbit.result.manager.currentPrototypeId,layer:_2ef});
}
var _2f1=(rabbit.result.manager.isExport)?"jsonp":"html";
ajax=rabbit.communication.manager.get(url,_2f1,{containerId:"__containerId__",mode:rabbit.util.getMode(),viewMode:rabbit.parameters.viewMode,fontFamily:rabbit.parameters.fontFamily},{crossDomain:rabbit.result.manager.isExport});
if(!rabbit.result.manager.isExport){
ajax.done(this.addLayerFromHtml.bind(this));
}
this.objects[_2ef]=new rabbit.data.Layer(_2ef,null,null);
}else{
...
var _2f2=$($.trim(html));
var _2f3=_2f2.find("#result");
$(_2f3).children().each(function(_2f4,_2f5){
_2f5=$(_2f5);
var _2f6=_2f5.data("layer-id");
var _2f7=_2f5.data("layer-type");
var html=$.trim(_2f5[0].outerHTML);
if(this.objects[_2f6]){
this.objects[_2f6].data.id=_2f6;
this.objects[_2f6].data.layerType=_2f7;
this.objects[_2f6].data.html=html;
}else{
this.objects[_2f6]=new rabbit.data.Layer(_2f6,_2f7,html);
}
rabbit.facade.raiseEvent(rabbit.events.layerLoaded,this.objects[_2f6]);
}.bind(this));
_2f2.find("#border-wrapper > div").prependTo(".border-wrapper");
_2f2.find("#styles > style").appendTo("body");
var _2f8=_2f2.find("#json").text();
if(_2f8){
var _2f9=JSON.parse(_2f8);
rabbit.data.pageStore.addPage(_2f9);
}
}};
rabbit.data.Layer=rabbit.util.Class(rabbit.data.Base,function(sup){
this.init=function(id,_2fa,html){
this.data={id:id,layerType:_2fa,html:html};
};
});
rabbit.data.pageStore={objects:{},init:function(){
var _2fb=$("#pageNames").html();
if((_2fb!==null)&&(_2fb!=="__pageNames__")){
_2fb=JSON.parse(_2fb);
}
var _2fc=rabbit.data.raw.pages;
for(var id in _2fc){
this.addPage(_2fc[id]);
}
rabbit.event.manager.raiseEvent(rabbit.events.pageStoreLoaded);
},addPage:function(_2fd){
this.objects[_2fd.id]=new rabbit.data.Page(_2fd);
...
var _2fe=rabbit.data.raw.folders;
for(var id in _2fe){
this.objects[id]=new rabbit.data.Folder(_.extend(_2fe[id],{id:id}));
}
...
this.init=function(_2ff,_300,_301,_302){
this.data={stencilId:_2ff,interactionId:_300,uniqueId:_2ff+"-"+_300,action:_301,reactions:_302};
};
...
_.each(this.data.reactions,function(_303){
if(!_.has(rabbit.interaction.manager.reactions,_303.type)){
console.error("Reaction \""+_303.type+"\" is not supported");
return;
}
var init=rabbit.interaction.manager.reactions[_303.type].init;
if(typeof init==="function"){
init(this,_303);
}
}.bind(this));
rabbit.facade.registerOnEvent(this.data.uniqueId,function(e){
_.each(this.data.reactions,function(_304){
var _305=parseInt(_304.delay,10)||0;
setTimeout(function(){
rabbit.interaction.manager.reactions[_304.type].callback(e,this,_304);
}.bind(this),_305);
}.bind(this));
...
},createDiscussion:function(_306,_307,x,y,data){
var url=rabbit.communication.manager.getUrl("createDiscussion",{layerId:_306});
data=data||{};
data=_.defaults(data,{title:_307,x:x,y:y,pageX:x,pageY:y,referenceId:rabbit.facade.getCurrentPageId(),pageId:rabbit.facade.getCurrentPageId(),layerContainerId:rabbit.facade.getCurrentPageId()});
return rabbit.data.discussionStore.callAjax(url,data);
},deleteDiscussion:function(_308){
delete this.objects[_308.data.id];
var url=rabbit.communication.manager.getUrl("deleteDiscussion",{layerId:_308.data.layerId});
return this.callAjax(url,{discussion:_308.data.id});
},flush:function(){
this.objects={};
rabbit.event.manager.raiseEvent(rabbit.events.discussionStoreChanged);
},getFromLayer:function(_309){
var url=rabbit.communication.manager.getUrl("getDiscussions",{layerId:_309});
...
var _30a=this.objects[id];
if(_30a){
_30a.setData(data.discussions[id]);
}else{
_30a=new rabbit.data.Discussion();
_30a.setData(data.discussions[id]);
this.objects[id]=_30a;
}
}
...
this.move=function(x,y,_30b,_30c,_30d,_30e,_30f,_310){
this.data.x=x;
this.data.y=y;
this.data.pageX=_30b;
this.data.pageY=_30c;
this.data.referenceId=_30d;
this.data.pageId=_30e;
this.data.layerId=_30f;
this.data.layerContainerId=_310;
var url=rabbit.communication.manager.getUrl("moveDiscussion",{layerId:this.data.layerId});
return rabbit.data.discussionStore.callAjax(url,{discussion:this.data.id,x:Math.floor(x),y:Math.floor(y),pageX:Math.floor(_30b),pageY:Math.floor(_30c),referenceId:_30d,pageId:_30e,layerId:_30f,layerContainerId:_310});
};
this.rename=function(_311){
if(this.data.title===_311){
return;
}
var _312=this.data.title;
this.data.title=_311;
...
var _313=t("result.discussion.title-changed").replace("__oldTitle__",_312).replace("__newTitle__",_311);
this.addEntry(_313);
return ajax;
};
...
this.setState=function(_314){
var url=rabbit.communication.manager.getUrl("setStateDiscussion",{layerId:this.data.layerId});
return rabbit.data.discussionStore.callAjax(url,{discussion:this.data.id,state:_314});
};
});
...
var _315=rabbit.facade;
return {init:function init(){
},adjustBackgroundImage:function adjustBackgroundImage(_316){
var _317=document.getElementById("borderDiv");
_317.style.width=_316.data.width+"px";
_317.style.height=_316.data.height+"px";
var _318=document.getElementById("repositorybackground");
_318.setAttribute("width",_316.data.width);
_318.setAttribute("height",_316.data.height);
_318.setAttribute("style","width:"+_316.data.width+"px;height:"+_316.data.height+"px;");
this._replaceBackgroundImage(_316);
},_replaceBackgroundImage:function _replaceBackgroundImage(_319){
var _31a,_31b;
if(!_315.vml){
_31a=document.getElementById("repositorybackground");
_31b=_31a.getElementsByTagNameNS("http://www.w3.org/2000/svg","image")[0];
_31b.setAttribute("width",_319.data.width);
_31b.setAttribute("height",_319.data.height);
if(_319.data.image!==""){
_31b.setAttribute("display","inherit");
_31b.setAttributeNS("http://www.w3.org/1999/xlink","href",_319.data.image);
}else{
_31b.setAttribute("display","none");
_31b.removeAttributeNS("http://www.w3.org/1999/xlink","href");
}
}else{
_31a=document.getElementById("repositorybackground");
_31b=document.createElement("img");
_31b.style.width="";
_31b.style.height="";
_31b.setAttribute("src",_319.data.image.replace(/_(\d)+\Z/,""));
_31a.replaceChild(_31b,_31a.firstChild);
if(_319.data.image===""){
_31b.style.display="none";
}else{
_31b.style.display="inline";
this._adjustBackgroundImgSize(_319.data.width,_319.data.height);
}
}
},_adjustBackgroundImgSize:function _adjustBackgroundImgSize(_31c,_31d){
if(!document.images[0].complete){
window.setTimeout("rabbit.plugins.background._adjustBackgroundImgSize("+_31c+", "+_31d+");",100);
return;
}
var _31e=document.images[0].width;
var _31f=document.images[0].height;
if(_31e/_31f>_31c/_31d){
document.images[0].width=_31c;
document.images[0].height=_31f*_31c/_31e;
}else{
document.images[0].width=_31e*_31d/_31f;
document.images[0].height=_31d;
}
}};
}();
rabbit.facade.registerPlugin(rabbit.plugins.background);
rabbit.plugins.gps=function(){
var _320=rabbit.facade;
var _321={};
var _322=[];
var _323={nyc:{latitude:40.714353,longitude:-74.005973},paris:{latitude:48.856614,longitude:2.352222},pidoco:{latitude:52.509561,longitude:13.451579},warschauer60:{latitude:52.509754,longitude:13.451715},alexanderplatz:{latitude:52.521832,longitude:13.413168}};
return {trackPositionWithJavaScript:true,trackPosition:false,init:function init(){
this.startTrackPositon();
_320.registerOnEvent("positionChanged",this.positionChanged,this);
_320.registerAction("gps",{availableOnDesktop:false,init:function(){
rabbit.plugins.gps.trackPosition=true;
},render:function(_324){
if(_324.trigger==="both"){
return t("interaction.action.gps.userDescription.both");
}else{
if(_324.trigger==="enter"){
return t("interaction.action.gps.userDescription.enter");
}else{
if(_324.trigger==="leave"){
return t("interaction.action.gps.userDescription.leave");
}
}
}
},defineEvent:function(_325){
var area=JSON.parse(_325.data.action.area);
rabbit.plugins.gps.registerMoveInOutZone(area.latitude,area.longitude,area.distance,_325.data.action.trigger,function(e){
rabbit.interaction.manager.raiseInteraction(_325,e);
});
}});
...
navigator.geolocation.getCurrentPosition(function(_329){
rabbit.plugins.gps.positionChanged(_329.coords);
_326=setInterval(_328,_327);
},function(){
console.log("ERROR GPS!");
},{maximumAge:_327,enableHighAccuracy:true,timeout:10000});
}
clearInterval(_326);
}
};
...
this.positionChanged({latitude:_323[name].latitude,longitude:_323[name].longitude});
},registerMoveInOutZone:function(_32a,_32b,_32c,_32d,_32e){
_322.push({latitude:_32a,longitude:_32b,distance:_32c,callback:_32e,trigger:_32d,wasInArea:false});
},positionChanged:function(_32f){
for(var i=0;i<_322.length;i++){
var area=_322[i];
var _330=this.isPositionInArea(_32f,area);
if(_330&&!area.wasInArea&&area.trigger==="enter"||!_330&&area.wasInArea&&area.trigger==="leave"||_330!==area.wasInArea&&area.trigger==="both"){
area.callback();
}
area.wasInArea=_330;
}
},isPositionInArea:function(_331,area){
return this.calculateDistance(_331.latitude,_331.longitude,area.latitude,area.longitude)<area.distance;
},calculateDistance:function(lat1,lon1,lat2,lon2){
var _332=function(deg){
return deg*(Math.PI/180);
};
var R=6371;
var dLat=_332(lat2-lat1);
var dLon=_332(lon2-lon1);
var a=Math.sin(dLat/2)*Math.sin(dLat/2)+Math.cos(_332(lat1))*Math.cos(_332(lat2))*Math.sin(dLon/2)*Math.sin(dLon/2);
...
var _333=rabbit.facade;
return {init:function(){
_333.registerAction("keypress",{makeableOnDesktop:true,render:function(_334){
return t("interaction.action.keypress.userDescription");
},defineEvent:function(_335){
var _336=_335.data.action.sequence;
if(_336){
Mousetrap.bind(_336,function(){
rabbit.interaction.manager.raiseInteraction(_335,{});
});
}
}});
}};
...
var _337=rabbit.facade;
return {audiofiles:{},audios:{},init:function(){
_337.registerReaction("sound",{init:function(_338,_339){
if(!window.Audio){
return;
}
var id=_339.soundUploader;
...
},callback:function(_33a,_33b,_33c){
var _33d=rabbit.plugins.sound.audiofiles[_33c.soundUploader];
if(!_33d){
return;
}
_33d.play();
...
var _33e=rabbit.facade;
return {init:function(){
_33e.registerReaction("systemAlert",{callback:function(_33f,_340,_341){
this.alert(_341.title,_341.text,_341.buttonName);
}.bind(this)});
},alert:function(_342,text,_343){
if(_33e.runningInApp()){
rabbit.facade.mobile.trigger("pidoco:systemAlert",{title:_342,text:text,buttonName:_343});
}else{
alert(text);
}
}};
...
var _344=rabbit.facade;
return {init:function(){
_344.registerAction("flip",{makeableOnDesktop:false,render:function(_345){
return t("interaction.action.flip.userDescription");
},defineEvent:function(_346){
new Fliptiltshake("flip",function(){
rabbit.interaction.manager.raiseInteraction(_346,{});
});
Fliptiltshake.start();
}});
}};
...
var _347=rabbit.facade;
return {paused:false,init:function(){
_347.registerAction("tilt",{makeableOnDesktop:false,render:function(_348){
return t("interaction.action.tilt.userDescription");
},defineEvent:function(_349){
new Fliptiltshake("tilt",{rotation:_349.data.action.rotation,direction:(_349.data.action.direction==="both")?null:_349.data.action.direction,angle:_349.data.action.angle,callback:function(){
if(rabbit.plugins.tilt.paused){
return;
}
var _34a=rabbit.interaction.manager.raiseInteraction(_349,{});
if(_34a){
...
var _34b=rabbit.facade;
return {init:function(){
_34b.registerAction("shake",{makeableOnDesktop:false,render:function(_34c){
return t("interaction.action.shake.userDescription");
},defineEvent:function(_34d){
var _34e=(_34b.isIOS)?_34d.data.action.intensity:_34d.data.action.intensity*10;
new Fliptiltshake("shake",{threshold:_34e,durationMin:_34d.data.action.duration,callback:function(){
rabbit.interaction.manager.raiseInteraction(_34d,{});
}});
Fliptiltshake.start();
}});
}};
...
_34f.registerAction("orientation",{makeableOnDesktop:false,render:function(_351){
var _352=_351.data.action;
if(_352.direction==="portrait"){
...
},defineEvent:function(_353){
_34f.registerOnEvent("orientationChanged",function(_354){
if(_353.data.action.direction==_354){
rabbit.interaction.manager.raiseInteraction(_353,{});
}
},this);
}});
},orientationChanged:function(_355){
var _356=(_355===90||_355===-90)?"landscape":"portrait";
if(_350!=_356){
_350=_356;
_34f.raiseEvent("orientationChanged",_356);
}
}};
}();
...
},frameChanged:function(_357,_358){
var top=0,left=0;
if(rabbit.facade.isFrameDisplayed){
left=rabbit.common.frames[_357][_358].frameBorderLeft;
top=rabbit.common.frames[_357][_358].frameBorderTop;
}
this.container.css({left:left,top:top});
},newInteractionRegistered:function(_359){
var _35a=_359.data.action;
var _35b=typeof rabbit.interaction.manager.actions[_35a.type].makeableOnDesktop==="function"?rabbit.interaction.manager.actions[_35a.type].makeableOnDesktop(_35a):rabbit.interaction.manager.actions[_35a.type].makeableOnDesktop;
if(_35b){
return;
}
if(this.interactions[_359.data.uniqueId]){
return;
}
var _35c=_359.data.stencilId;
var _35d=document.getElementById(_35c);
if($(_35d).parents(".transition-wrapper:first").length){
return;
}
var _35e=$(_35d).closest(".mobile-interaction-potential-trigger");
var _35f=_35e.attr("id");
var _360=$(_35e).position();
var _361=true;
if($(_35d).hasClass("layer")){
_361=false;
}
var _362=this.triggerGroups[_35f];
if(!_362){
_362=$("<div class=\"mobile-interactions-trigger-group-"+_35f+" mobile-interactions-trigger-group\" data-trigger-id=\""+_35f+"\"></div>");
this.triggerGroups[_35f]=_362;
$(_35e).mouseenter(function(e){
this.displayInteractions(_362);
return false;
}.bind(this)).mouseleave(function(e){
this.hideAllInteractions();
if(_361){
var id=$(_35d).closest(".repository").attr("id");
this.displayInteractions($(".mobile-interactions-trigger-group-"+id));
}
return false;
}.bind(this));
_362.data("fromStencil",_361);
if(_361){
$(_35d).append(_362);
}else{
var _363=$(_35d).parent()&&$(_35d).parent().parent()&&$(_35d).parent().parent().parent()&&$(_35d).parent().parent().parent().hasClass("renderIntern");
if(_363){
$(_35d).parent().parent().parent().parent().append(_362);
}else{
this.container.append(_362);
}
}
_362.css({left:0,top:-27/rabbit.facade.getScaleFactor()});
$(_362).mouseenter(function(e){
this.displayInteractions(_362);
return false;
}.bind(this)).mouseleave(function(e){
this.hideAllInteractions();
...
var _364=$("<div class=\"active interaction-trigger interaction-trigger-"+_359.data.uniqueId+" interaction-trigger-"+_35a.type+"\" title=\""+t("interaction-trigger-"+_359.data.action.type+"-tooltip")+"\">"+t("trigger-label-"+_35a.type)+"</div>");
if(!_361){
_364.addClass("interaction-trigger-layer-"+_35c.replace("-layer",""));
}
_364.click(function(){
rabbit.facade.raiseInteraction(_359);
this.hideAllInteractions();
}.bind(this));
_362.append(_364);
this.interactions[_359.data.uniqueId]=_359;
},hideAllInteractions:function(){
$(".mobile-interactions-trigger-group").removeClass("visible");
},displayInteractions:function(_365){
$(".mobile-interactions-trigger-group").removeClass("visible");
$(_365).addClass("visible");
...
},pageLoaded:function(page,_366){
this.changeLinks(page.data.id);
},changeLinks:function(_367){
var _368=rabbit.communication.manager.buildEditUrl(rabbit.result.manager.currentPageNr);
var _369=rabbit.facade.getUrlPattern().replace("__page__",_367);
var _36a=_369.replace(this.mode,"sketched").replace("?fontFamily=arial","");
var _36b=_369.replace(this.mode,"sketchedArial");
var _36c=_369.replace(this.mode,"plain").replace("?fontFamily=arial","");
this.toolbar.find(".edit-btn").attr("href",_368);
this.toolbar.find(".sketched-btn").attr("href",_36a);
this.toolbar.find(".sketched-arial-btn").attr("href",_36b);
this.toolbar.find(".plain-btn").attr("href",_36c);
}};
...
rabbit.facade.registerReaction("showOverlay",{init:function(_36d,_36e){
this.prepareOverlay(_36d.data.uniqueId,_36e.target);
}.bind(this),callback:function(_36f,_370,_371){
this.showOverlay(_370.data.uniqueId,_371.target);
}.bind(this)});
rabbit.facade.registerReaction("hideOverlay",{callback:function(_372,_373,_374){
this.hideOverlay();
}.bind(this)});
this.overlayContainer=$("body");
},getOrCreateOverlayRepository:function(_375,page){
var _376=this.overlayContainer.find("> div[data-page-id=\""+page.data.id+"\"]");
if(!_376.length){
_376=$("<div></div>");
_376.addClass("overlay").addClass("repository").attr("data-original-layer-id",page.data.id).attr("id","overlay-"+_375).attr("data-page-id",page.data.id).attr("data-apply-scale-factor","").appendTo(this.overlayContainer).css({width:page.data.width+"px",height:page.data.height+"px"}).data("has-rectangle",false);
}
return _376;
},prepareOverlay:function(_377,_378){
var ajax=rabbit.facade.loadLayer(_378);
ajax.done(function(){
var page=rabbit.data.pageStore.objects[_378];
if(page){
var _379=this.getOrCreateOverlayRepository(_377,page);
this.loadRectangle(page.data.width,page.data.height);
rabbit.ui.manager.createWrappers(_379,_378,true);
}
}.bind(this));
},loadRectangle:function(_37a,_37b){
if(this.hasRectangle(_37a,_37b)){
return;
}
if(rabbit.result.manager.isExport){
var _37c=(rabbit.browser==="ie")?"-ie":"";
url=rabbit.communication.manager.getUrl("rectangleExport",{height:_37b,width:_37a,mode:rabbit.util.getMode()});
...
ajax=rabbit.communication.manager.get(url,"html",{height:_37b,width:_37a});
ajax.success(function(html){
var _37d=$(html).children().first();
this.setRectangle(_37a,_37b,_37d);
}.bind(this));
}
},setRectangle:function(_37e,_37f,html){
this.rectangles[_37e+"x"+_37f]=html;
},getRectangle:function(_380,_381){
return $(this.rectangles[_380+"x"+_381]).clone();
},hasRectangle:function(_382,_383){
return typeof this.rectangles[_382+"x"+_383]!=="undefined";
},showOverlayBackground:function(){
$(".overlay-background").show();
},hideOverlayBackground:function(){
$(".overlay-background").hide();
},showOverlay:function(_384,_385){
var id="overlay-"+_384;
var page=rabbit.data.pageStore.objects[_385];
var _386=rabbit.facade.getCurrentPage();
var _387=this.getOrCreateOverlayRepository(_384,page);
if(page){
var _388=page.data.width;
var _389=page.data.height;
if(!_387.data("has-rectangle")){
_387.append(this.getRectangle(_388,_389));
_387.data("has-rectangle",true);
}
var _38a=$(document).height()>$(window).height();
if(rabbit.facade.isFrameDisplayed&&_38a){
var _38b=$(".border-wrapper")[0].getBoundingClientRect();
var top=_38b.top+_38b.height/2-parseInt(_389)/2+window.scrollY;
var left=_38b.left+_38b.width/2-parseInt(_388)/2+window.scrollX;
}else{
top=$(window).height()/2+window.scrollY-parseInt(_389)/2;
left=$(window).width()/2+window.scrollX-parseInt(_388)/2;
}
_387.appendTo(this.overlayContainer).show().css({top:top,left:left,transform:"scale("+rabbit.facade.getScaleFactor()+", "+rabbit.facade.getScaleFactor()+")"});
rabbit.ui.manager.showPage(_387,_385);
this.showOverlayBackground();
this.shownOverlays.push(_387);
}else{
}
},hideOverlay:function(){
var _38c=this.shownOverlays.pop();
_38c.hide();
this.hideOverlayBackground();
}};
rabbit.facade.registerPlugin(rabbit.plugins.overlay);
rabbit.plugins.scrollTo=function(){
var _38d=rabbit.facade;
return {init:function(){
_38d.registerReaction("scrollTo",{callback:function(_38e,_38f,_390){
this.scrollTo(_390.position,_390.duration);
}.bind(this)});
},scrollTo:function(_391,_392){
var _393=$("html, body");
var _394=$(".border-wrapper");
if(rabbit.facade.isFrameDisplayed&&_394[0].scrollHeight>_394.height()){
_393=_394;
}
if(_391==="bottom"){
_393.animate({scrollTop:_393[0].scrollHeight},parseInt(_392));
}else{
_393.animate({scrollTop:0},parseInt(_392));
}
}};
}();
rabbit.facade.registerPlugin(rabbit.plugins.scrollTo);
rabbit.plugins.startDialer={shownOverlays:[],rectangles:{},init:function(){
rabbit.facade.registerReaction("startDialer",{callback:function(_395,_396,_397){
this.startDialer(_397.phoneNumber);
}.bind(this)});
},startDialer:function(_398){
window.location.href="tel:"+_398;
}};
...
var _399=e.targetTouches[i];
var _39a=this.makeCircle(_399.pageX-this.offset.left,_399.pageY-this.offset.top);
this.touchViewer[0].appendChild(_39a);
}
e.preventDefault();
},touchEndListener:function(){
setTimeout(function(){
var _39b=this.touchViewer.find("div");
_39b.each(function(){
...
var _39c=this.touchViewer.find("div");
_39c.each(function(){
...
var _39d=document.getElementsByClassName("touch");
for(var i=0;i<_39d.length;i++){
_39d[i].setAttribute("class",_39d[i].getAttribute("class")+" touch-success");
}
}};
}();
rabbit.facade.registerPlugin(rabbit.plugins.gestureHighlight);
rabbit.plugins.hold={init:function(){
rabbit.facade.registerAction("hold",{makeableOnDesktop:true,render:function(_39e){
return t("interaction.action.hold.userDescription");
},defineEvent:function(_39f){
var _3a0=Hammer(document.getElementById(_39f.data.stencilId),{hold_timeout:_39f.data.action.timeout});
_3a0.on("hold",function(e){
rabbit.interaction.manager.raiseInteraction(_39f,{});
});
}});
}};
rabbit.facade.registerPlugin(rabbit.plugins.hold);
rabbit.plugins.valueChanged={listenedGroups:{},init:function(){
rabbit.facade.registerAction("booleanValueChanged",{makeableOnDesktop:true,render:function(_3a1){
return t("interaction.action.booleanValueChanged.userDescription");
},defineEvent:function(_3a2){
var _3a3=_3a2.data.stencilId;
var _3a4=$("#"+_3a3);
if(_3a4.hasClass("radiobutton")){
var _3a5=_3a4.find("input:first").attr("name");
if(!_.has(rabbit.plugins.valueChanged.listenedGroups,_3a5)){
rabbit.plugins.valueChanged.listenedGroups[_3a5]=[];
$("input[name=\""+_3a5+"\"]").change(function(e){
var _3a6=$(e.target).val();
var _3a7=$(e.target).data("old-selected-radiobutton-id");
for(var i=0;i<rabbit.plugins.valueChanged.listenedGroups[_3a5].length;i++){
var _3a8=rabbit.plugins.valueChanged.listenedGroups[_3a5][i];
var _3a9=_3a8.data.stencilId;
var _3aa=_3a8.data.action.selected;
if(_3a6===_3a9&&_3aa==="yes"||_3a7===_3a9&&_3aa==="no"||(_3a6===_3a9||_3a7===_3a9)&&_3aa==="toggle"){
rabbit.interaction.manager.raiseInteraction(_3a8,rabbit.interaction.manager.serializeEvent(e));
}
}
$("input[name=\""+_3a5+"\"]").data("old-selected-radiobutton-id",_3a6);
});
}
rabbit.plugins.valueChanged.listenedGroups[_3a5].push(_3a2);
}else{
if(_3a4.hasClass("checkbox")){
$("#"+_3a2.data.stencilId+" input:first").change(function(e){
if($(e.target).is(":checked")===(_3a2.data.action.selected==="yes")||_3a2.data.action.selected==="toggle"){
rabbit.interaction.manager.raiseInteraction(_3a2,rabbit.interaction.manager.serializeEvent(e));
}
});
}else{
if(_3a4.hasClass("iphoneSwitch")){
var _3ab=function(id){
if(_3a2.data.stencilId===id){
rabbit.interaction.manager.raiseInteraction(_3a2);
}
};
if(_3a2.data.action.selected==="yes"||_3a2.data.action.selected==="toggle"){
rabbit.facade.registerOnEvent(rabbit.events.switchOffSwitch,_3ab,this);
}
if(_3a2.data.action.selected==="no"||_3a2.data.action.selected==="toggle"){
rabbit.facade.registerOnEvent(rabbit.events.switchOnSwitch,_3ab,this);
}
}
}
}
}});
rabbit.facade.registerAction("stringValueChanged",{makeableOnDesktop:true,render:function(_3ac){
return t("interaction.action.stringValueChanged.userDescription");
},defineEvent:function(_3ad){
$("#"+_3ad.data.stencilId).change(function(e){
if(e.target.value===_3ad.data.action.value){
...
rabbit.facade.registerOnEvent(rabbit.events.newInteractionRegistered,function(_3ae){
var _3af=document.getElementById(_3ae.getData().stencilId);
var _3b0=_3af.hasAttribute("data-stencil-id");
var _3b1=_3af.hasAttribute("data-layer-id");
var id=_3ae.getData().stencilId;
if(!_3b0&&!_3b1&&!this.detailFootnotes[id]){
this.detailFootnotes[id]=_.size(this.detailFootnotes)+1;
}
},this);
rabbit.facade.registerOnEvent(rabbit.events.pageReady,function(){
$(".has-footnote").each(function(_3b2,_3b3){
var _3b4=_3b3.getAttribute("data-stencil-id");
if(!_3b4){
_3b4=_3b3.getAttribute("data-layer-id");
}
if(!this.detailFootnotes[_3b4]){
this.detailFootnotes[_3b4]=_.size(this.detailFootnotes)+1;
}
}.bind(this));
},this);
...
},showFootnote:function(_3b5,x,y,type,_3b6,_3b7,_3b8,_3b9,text,_3ba){
var _3bb=_3b5.offset();
var _3bc=x;
var _3bd=y;
if(!_3b8){
_3bc-=_3bb.left;
...
if(!_3b7){
if(type=="detail"){
_3be=(this.counterDetailFootnotes++)+1;
}else{
if(type=="discussion"){
_3be=this.getDiscussionLetters(this.counterDiscussionFootnotes++);
}
}
_3bf=$("<div class=\"footnote-marker footnote-marker-"+type+"\">"+_3be+"</div>").css({left:_3bc,top:_3bd});
_3b5.append(_3bf);
}
this.placedMarkers.push({stencilOrLayerId:_3b6,stencilUniqueId:_3b5.attr("id"),type:type,index:_3be,x:x,y:y,outsideOfPage:_3b7,inStencilInteraction:_3b8,target:_3b9,text:text,footnoteId:_3ba,footnoteElement:_3bf});
},getShownFootnoteIndexes:function(type){
var _3c0={};
for(var i=0;i<this.placedMarkers.length;i++){
var _3c1=this.placedMarkers[i];
if(!type||_3c1.type==type){
_3c0[_3c1.index]={index:_3c1.index,stencilUniqueId:_3c1.stencilUniqueId,outsideOfPage:_3c1.outsideOfPage,inStencilInteraction:_3c1.inStencilInteraction,stencilOrLayerId:_3c1.stencilOrLayerId,target:_3c1.target,text:_3c1.text,footnoteId:_3c1.footnoteId};
}
}
return _3c0;
...
},showDetailFootnotes:function(_3c2){
for(var _3c3 in this.detailFootnotes){
var _3c4=false;
var _3c5=$("[data-stencil-id=\""+_3c3+"\"], .wrapper[data-layer-id=\""+_3c3+"\"][data-layer-id=\""+_3c2+"\"]");
var _3c6=null,text=null;
if(!_3c5.length){
_3c5=$("#"+_3c3);
_3c4=true;
_3c6=_3c5.attr("data-href");
text=_.str.clean(_3c5.text());
text=_.str.truncate(text,20);
_3c3=null;
}
for(var i=0;i<_3c5.length;i++){
var _3c7=$(_3c5.get(i));
if(!_3c7.closest(".wrapper[data-layer-id=\""+_3c2+"\"]").length){
continue;
}
var _3c8=_3c7.offset();
var _3c9=_3c7.width();
if(_3c4){
_3c9=_3c7.width()/2;
}
var x=_3c8.left+_3c9;
var y=_3c8.top-20;
var _3ca=this.findPosition(x,y,"x",1);
this.placedMarkersInPageCoordinateSystem.push({x:_3ca.x,y:_3ca.y});
if(_3c4){
var _3cb=_3c7.position();
_3ca.x=_3cb.left+_3c9+(x-_3ca.x);
_3ca.y=_3cb.top-20+(y-_3ca.y);
}
this.showFootnote(_3c7,_3ca.x,_3ca.y,"detail",_3c3,_3ca.outsideOfPage,_3c4,_3c6,text);
}
}
this.sortFootenotes();
},sortFootenotes:function(){
this.placedMarkers=_.sortBy(this.placedMarkers,function(_3cc){
return ($(_3cc.footnoteElement).offset())?$(_3cc.footnoteElement).offset().left:100000;
});
for(var i=0;i<this.placedMarkers.length;i++){
var _3cd=this.placedMarkers[i].footnoteElement;
$(_3cd).text(i+1);
this.placedMarkers[i].index=i+1;
}
},getShownDetailFootnotes:function(){
return this.getShownFootnoteIndexes("detail");
},getDiscussionLetters:function(_3ce){
var v="abcdefghijklmnopqrstuvwxyz".split("");
var _3cf="";
var nr=Math.floor(_3ce/26);
var mod=_3ce%26;
...
_3cf+=v[mod];
return _3cf;
},showDiscussionFootnotes:function(_3d0){
var _3d1="abcdefghijklmopqrestuvwxyz".split("");
var _3d2=$("#repository").offset();
var _3d3=this.discussionFootnotes[_3d0];
if(_.isArray(_3d3)){
for(var i=0;i<_3d3.length;i++){
var _3d4=_3d3[i];
var _3d5=_3d4.referenceId;
var _3d6=$(".wrapper-"+_3d0+">.layer [data-stencil-id=\""+_3d5+"\"]");
if(_3d6.length===0){
_3d6=$("[data-page-id=\"page0001\"]");
}
for(var j=0;j<_3d6.length;j++){
var _3d7=$(_3d6.get(j));
var _3d8=_3d7.offset();
var x=_3d8.left+_3d4.x;
var y=_3d8.top+_3d4.y;
var _3d9=this.findPosition(x,y,"x",1);
this.placedMarkersInPageCoordinateSystem.push({x:_3d9.x,y:_3d9.y});
this.showFootnote(_3d7,_3d9.x,_3d9.y,"discussion",_3d4.id,_3d9.outsideOfPage,null,null,null,_3d4.id);
}
}
}
},getShownDiscussionFootnotes:function(){
return this.getShownFootnoteIndexes("discussion");
},findPosition:function(x,y,_3da,deep){
deep=deep||1;
...
return this._findPosition(x,y,_3da,deep);
}
},_findPosition:function(x,y,_3db,deep){
var _3dc={x:x,y:y,outsideOfPage:false};
var _3dd=false;
var _3de=null;
var _3df=null;
var _3e0=null;
...
var _3e2=true;
var _3e3=true;
var _3e4=this.placedMarkersInPageCoordinateSystem[i];
var _3e5=x-_3e4.x;
if(Math.abs(_3e5)<this.markerSize){
_3e2=false;
if(_3e5>0){
_3de=Math.abs(_3e5);
}else{
...
var _3e6=y-_3e4.y;
if(Math.abs(_3e6)<this.markerSize){
_3e3=false;
if(_3e6>0){
_3e0=Math.abs(_3e6);
}else{
...
_3dc.x=Math.min(_3dc.x,$("#repository").width()-2*this.markerSize);
_3dc.y=Math.min(_3dc.y,$("#repository").height()-2*this.markerSize);
if(_3dd&&deep<100){
if(_3db=="x"){
var _3e7=true;
if(_3df===null&&x<xMax||_3de!==null&&_3df<_3de||x<0){
_3e7=false;
}
if(_3e7){
_3dc.x=x-this.markerSize;
}else{
_3dc.x=x+this.markerSize;
}
}
if(_3db=="y"){
var _3e8=true;
if(_3e1===null&&y<yMax||_3e0!==null&&_3e1<_3e0||y<0){
_3e8=false;
}
if(_3e8){
_3dc.y=y-this.markerSize;
}else{
_3dc.y=y+this.markerSize;
}
}
return this.findPosition(_3dc.x,_3dc.y,(_3db==="x")?"y":"x",++deep);
}else{
return _3dc;
}
}};
...
},highlightStencil:function(_3e9){
var _3ea=$("<div class=\"stencil-highlighter-highlighted\"></div>");
_3e9.append(_3ea);
},hideHighlightLayer:function(_3eb){
$(".layer[data-layer-id=\""+_3eb+"\"] .stencil .stencil-highlighter-highlighted").remove();
},showHighlightLayer:function(_3ec){
this.hideHighlightLayer(_3ec);
var _3ed=$(".layer[data-layer-id=\""+_3ec+"\"] .stencil");
for(var i=0;i<_3ed.length;i++){
this.highlightStencil($(_3ed.get(i)));
}
},deopacify:function(){
$(".stencil-highlighter-opacifyied").removeClass("stencil-highlighter-opacifyied");
},opacifyExceptLayer:function(_3ee){
this.deopacify();
var _3ef=$(".stencil");
for(var i=0;i<_3ef.length;i++){
var _3f0=$(_3ef.get(i));
if(!_3f0.closest(".layer[data-layer-id=\""+_3ee+"\"]").length){
_3f0.addClass("stencil-highlighter-opacifyied");
}
}
}};
...
var _3f1=document.querySelectorAll(".layer");
for(var i=0;i<_3f1.length;i++){
this.activateLinksForLayer(_3f1[i]);
}
},this);
rabbit.facade.registerOnEvent("layerStoreInserted",this.activateLinksForLayer,this);
},activateLinksForLayer:function(_3f2){
var _3f3=_3f2.querySelectorAll(".default-text2-container a[href]");
...
var id=link.id;
var _3f4=link.getAttribute("href");
rabbit.interaction.manager.registerInteraction(id,"tinymce-interaction-"+id,{"button":"left","id":"tinymce-action-"+id,"numberOfFinger":"1","type":"click"},[{"delay":"0","id":"tinymce-reaction-"+id,"options":"reloadOnly","target":_3f4,"transition":"none","type":"showPage"}]);
link.className=link.className+" pidoco-clickable-element interactive-element-highlighter";
link.setAttribute("data-href",_3f4);
...
$.ajax({url:rabbit.common.baseUrl+rabbit.util.appendVersionQuery("common/stencil-icons.svg"),method:"GET",success:function(data,_3f5,_3f6){
...
$.ajax({url:rabbit.common.baseUrl+rabbit.util.appendVersionQuery("common/frames.svg"),method:"GET",success:function(data,_3f7,_3f8){
var body=document.body;
body.insertBefore(data.firstChild,body.firstChild);
...
_3f9=rabbit.parameters.fitScreen;
}
}
var _3fa=false;
if(rabbit.parameters.isApi){
...
_3fa=!rabbit.parameters.showFrame;
}
}
rabbit.facade.registerUserPref("simulationFitScreen",_3f9);
rabbit.facade.registerUserPref("hidePageFrame",_3fa);
...
this.updateFrame(this.lastPage,this.lastRepository);
},frameReset:function(page,_3fd){
this.simulationScaled.css({transform:"scale(1)"});
this.borderWrapper[0].style.removeProperty("width");
this.borderWrapper[0].style.removeProperty("height");
},pageReady:function(page,_3fe){
this.lastPage=page;
this.lastRepository=_3fe;
this.pageLoaded(page,_3fe);
if(rabbit.facade.getUserPref("hidePageFrame")){
this.hideFrame();
}
setTimeout(function(){
...
},pageLoaded:function(page,_3ff,_400){
if(_3ff.attr("id")!="repository"){
return;
}
this.lastPage=page;
this.lastRepository=_3ff;
var _401=page.getData().frame;
var _402=page.getData().frameOrientation;
var _403=!rabbit.facade.getUserPref("hidePageFrame");
if(!rabbit.common.frames[_401]||!rabbit.common.frames[_401][_402]){
this.hideFrame(true);
}else{
if(_403){
this.showFrame(true);
...
},updateFrame:function(page,_404,_405){
if(!this.framesLoaded){
return;
}
var _406=true;
if(!_405){
this.frameReset(page,_404);
_406=false;
}
var _407=page.getData().frame;
var _408=page.getData().frameOrientation;
var _409=rabbit.common.frames.none;
var _40a=page.getData().width;
var _40b=page.getData().height;
var _40c=0;
var _40d=0;
if(_407=="custom"){
_408="custom";
...
if((!rabbit.common.frames[_407]||!rabbit.common.frames[_407][_408])){
...
var _40e=_407=="custom"&&(_40a<rabbit.common.frames.custom.sideMinLength||_40b<rabbit.common.frames.custom.sideMinLength);
if(!this.pageTooSmallForCustom&&_40e){
...
var _40f=!rabbit.facade.getUserPref("hidePageFrame");
if(_40f){
_409=rabbit.common.frames[_407];
if(_407!=="custom"){
_40a=_409[_408].innerWidth;
_40b=_409[_408].innerHeight;
}
_40c=_409[_408].frameBorderLeft;
_40d=_409[_408].frameBorderTop;
rabbit.facade.isFrameDisplayed=true;
}else{
rabbit.facade.isFrameDisplayed=false;
}
this.frame.firstElementChild.setAttribute("xlink:href","#"+_407+"-"+_408);
this.simulationScaled.css({transform:"scale(1)"});
var _410=1;
if(rabbit.facade.getUserPref("simulationFitScreen")&&!_406&&_40f){
var _411=30;
var _412=_409[_408].frameBorderTop*2+_40b+10;
_410=Math.min(1,(window.innerHeight-$(".toolbar-wrapper").height()-_411)/_412);
}
rabbit.facade.setScaleFactor(_410);
var _413=(rabbit.facade.isApi()||$("body").hasClass("plain"))?0:10;
this.simulationContainer.css({width:(_40c*2+_40a+_413)*_410,height:(_40d*2+_40b+_413)*_410});
var _414=_40a;
var _415=_40b;
this.borderWrapper.css("overflow","hidden");
if(!rabbit.facade.getUserPref("hidePageFrame")&&this.borderWrapper[0].scrollWidth>_414){
_415+=rabbit.util.getScrollbarWidth();
}
if(!rabbit.facade.getUserPref("hidePageFrame")&&this.borderWrapper[0].scrollHeight>_415){
_414+=rabbit.util.getScrollbarWidth();
}
this.borderWrapper.css({left:_40c,top:_40d,width:_414,height:_415,overflow:"auto"});
this.simulationScaled.css({transform:"scale("+_410+")"});
$("[data-apply-scale-factor]").css({transform:"scale("+_410+")"});
if(_407=="custom"){
rabbit.common.frames.adjusteCustomFrame(_40a,_40b);
}
rabbit.facade.raiseEvent(rabbit.events.frameChanged,_407,_408);
}};
...
var _416=rabbit.facade.getUserPref("simulationAlignment");
if(_416&&rabbit.plugins.prototypeAlignment[_416]&&!rabbit.facade.isPhantomJS()){
rabbit.plugins.prototypeAlignment[_416]();
}
},left:function(){
...
Mousetrap.bind("ctrl",function(_417){
if(!this.keyPressed){
...
var _418=rabbit.facade;
return {init:function(){
_418.registerAction("onPageLoad",{makeableOnDesktop:true,render:function(_419){
return t("interaction.action.onPageLoad.userDescription");
},defineEvent:function(_41a){
var _41b=$("#"+_41a.data.stencilId).data("layerId");
rabbit.facade.registerOnEvent(rabbit.events.pageLoaded,function(page,_41c){
if(_41b===page.data.id){
rabbit.interaction.manager.raiseInteraction(_41a,{});
}
},this);
rabbit.facade.registerOnEvent(rabbit.events.pageReady,function(page,_41d){
if(_41b===page.data.id){
rabbit.interaction.manager.raiseInteraction(_41a,{});
}
},this);
...
return {init:function init(){
},setupAutocomplete:function setupAutocomplete(id,_41e){
_41e=_41e.split("|c");
var oDS=new YAHOO.util.LocalDataSource(_41e);
...
},layerStoreInsertedListener:function(_41f){
$(_41f).find(".stencil.textinput").click(function(){
rabbit.facade.markHighlightTouchesAsSuccessful();
});
...
rabbit.facade.registerOnEvent(rabbit.events.layerStoreInserted,this.layerStoreInsertedListener,this);
rabbit.facade.registerOnEvent(rabbit.events.pageReady,this.pageReadyListener,this);
},layerStoreInsertedListener:function(_420){
$(_420).find(".stencil.combobox").click(function(){
rabbit.facade.markHighlightTouchesAsSuccessful();
});
},pageReadyListener:function(){
...
var _421=600;
var _422=".accordion-header";
var _423=".accordion-content";
var _424="accordion-active";
var _425=30;
var _426=function(_427){
var _428=$(_427).parents().children(_422);
var _429=_428.index(_427);
return _429;
};
var _42a=function(_42b){
return $(_42b).closest(".stencil").attr("id");
};
var _42c=function(_42d){
return $("#"+_42d).find(_422).length;
};
var _42e=function(_42f,_430,_431){
var _432=$("#"+_42f+">div>"+_422).length;
$("#"+_42f).find(_423+">div, "+_423+">iframe").css("position","relative").css("left","0px").css("top","0px").css("width",_430+"px").css("height",(_431-_432*_425-2)+"px");
};
return {_accordions:{},init:function init(){
},setupAccordion:function(id,_433,_434,_435){
var _436=_42c(id);
if(_435<1){
_435=1;
}
...
_435--;
$("#"+id).find(_422).click({"accordionObject":this},this.raiseClickCallback);
_42e(id,_433,_434);
this.showTab(id,_435,false);
},showTab:function(id,_437,_438){
this._accordions[id]=_437;
if(_438){
$("#"+id).find(_423).slideUp(_421);
}else{
$("#"+id).find(_423).hide();
}
var _439=$("#"+id).find(_422).removeClass(_424)[_437];
$(_439).addClass(_424).next().slideDown(_421,function onCompleteCallback(){
...
},clickCallback:function(that,_43a){
var _43b=_426(_43a);
var _43c=_42a(_43a);
if(that._accordions[_43c]===_43b){
return;
}
rabbit.facade.markHighlightTouchesAsSuccessful();
that.showTab(_43c,_43b,true);
}};
}();
...
var _43d=rabbit.facade;
return {init:function init(){
_43d.registerOnEvent(rabbit.events.buttonMouseOver,this.onMouseOver,this);
_43d.registerOnEvent(rabbit.events.buttonMouseOut,this.onMouseOut,this);
...
var _43e=rabbit.facade;
return {init:function init(){
rabbit.facade.registerOnEvent(rabbit.events.checkBoxClicked,this.onClick,this);
},onClick:function onClick(_43f,_440){
rabbit.facade.markHighlightTouchesAsSuccessful();
console.log("Click to checkbox "+_43f);
var _441=document.getElementById(_43f);
if(_441==null){
return true;
}
var _442=document.getElementById(_440);
if(_442==null){
return true;
}
if(!_441.checked){
_442.setAttribute("visibility","hidden");
}else{
_442.setAttribute("visibility","inherit");
}
return true;
}};
}();
...
var _445=false;
var _446=null;
var _447=function(id){
for(var i=0;i<_444.length;i++){
var _448=_444[i];
if(_448.calendarId==id){
return _448;
}
}
return null;
};
var _449=function(id,year,_44a){
var _44b=_447(id);
_44b.calendar.setYear(year);
_44b.calendar.setMonth(_44a);
_44b.calendar.render();
};
var _44c=function _hideCalendar(id,_44d,_44e){
if(_44d){
document.getElementById(id+"_input").value=_44d;
}
var _44f=_447(id);
_44f.calendarVisible=false;
var svg=document.getElementById(_44f.calendarId+"_open_calendar");
if(svg){
...
_44f.overlay.hide();
_445=false;
$("html").unbind("click",_446);
};
var _450=function _showCalendar(id,_451){
var _452=_447(id);
_452.calendarVisible=true;
_452.calendar.show();
_452.overlay.show();
_445=true;
var svg=document.getElementById(_452.calendarId+"_open_calendar");
if(svg){
...
$("html").bind("click",_446);
};
var _453=function _453(_454){
for(var i=0;i<_454.childNodes.length;i++){
var _455=_454.childNodes[i];
if(_455.nodeType!=1){
continue;
}
if(_455.getAttribute("id")==undefined){
_455.setAttribute("id",_454.getAttribute("id")+"_"+i);
}
arguments.callee(_455);
}
};
var _456=function _456(evt){
if(!evt){
return;
}
if(!_443.vml){
...
return {init:function init(){
_443.registerOnEvent(rabbit.events.click,this.hideDatePickerOnClick,this);
rabbit.facade.registerOnEvent(rabbit.events.showDatepicker,_450,this);
rabbit.facade.registerOnEvent(rabbit.events.hideDatepicker,_44c,this);
rabbit.facade.registerOnEvent(rabbit.events.changeDatepickerPage,_449,this);
},calendarOpen:function(id){
return _445;
}(),setupDatepicker:function setupDatepicker(id){
try{
var _457=new YAHOO.widget.Overlay(id+"_ov",{zIndex:9990,width:"200px",height:"200px",context:[id+"_input","tl","bl"]});
_457.render();
...
cal.cfg.setProperty("MONTHS_SHORT",["Jan","Feb","M�r","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"]);
cal.cfg.setProperty("MONTHS_LONG",["Januar","Februar","M�rz","April","Mai","Juni","Juli","August","September","Oktober","November","Dezember"]);
...
_458.overlay=_457;
_458["calendarId"]=id;
_458["calendarVisible"]=false;
_444.push(_458);
cal.selectEvent.subscribe(rabbit.util.bind(function(evt,d){
var _459=this.formatIsoDate(d[0][0][0],d[0][0][1],d[0][0][2]);
rabbit.facade.raiseEvent(rabbit.events.hideDatepicker,_458.calendarId,_459,rabbit.util.userRole,"displayMouseClick");
},this),cal,true);
cal.render();
cal.hide();
_457.hide();
var _45a=id+"_cal";
_453(document.getElementById(id+"_cal"));
cal.changePageEvent.subscribe(rabbit.util.bind(function(evt,d){
var date=cal.cfg.getProperty("pagedate");
var year=date.getUTCFullYear();
var _45b=date.getMonth();
rabbit.facade.raiseEvent(rabbit.events.changeDatepickerPage,_458.calendarId,year,_45b,rabbit.util.userRole,"displayMouseClick");
_453(document.getElementById(_45a));
},this),cal,true);
YAHOO.util.Event.addListener(id+"_button","click",rabbit.util.bind(this.toggleCalendarCallback,this),_458);
YAHOO.util.Event.addListener(id+"_input","focus",rabbit.util.bind(this.toggleCalendarCallback,this),_458);
YAHOO.util.Event.addListener(id+"_ov","click",_456);
}
catch(e){
...
for(var i=0;i<_444.length;i++){
var _45c=_444[i];
if(_45c.calendarVisible){
rabbit.facade.raiseEvent(rabbit.events.hideDatepicker,_45c.calendarId,null,rabbit.util.userRole,"displayMouseClick");
}
}
}
},toggleCalendarCallback:function toggleCalendarCallback(evt,_45d){
if(!_45d.calendarVisible){
rabbit.facade.raiseEvent(rabbit.events.showDatepicker,_45d.calendarId,rabbit.util.userRole,"displayMouseClick");
this.calendarOpen=true;
}else{
rabbit.facade.raiseEvent(rabbit.events.hideDatepicker,_45d.calendarId,null,rabbit.util.userRole,"displayMouseClick");
...
var _461=function(_462,_463){
var menu=_45f(_462);
if(menu){
for(var i=0;i<_463.length;i++){
var _464=menu.getSubmenus();
...
var _465=function(_466,_467,_468){
if(_468&&_468!=rabbit.util.userRole){
var _469=_461(_466,_467);
if(_469){
_469.show();
}
}
...
var _46e=_461(_46b,_46c);
if(_46e){
_46e.hide();
}
}
};
var _46f=function(obj){
var menu=obj;
var _470=[];
...
$(_474.element).css({left:$(_474.parent.element).position().left,top:top});
};
var _475=function(_476){
var _477=-4;
var _478=$(_476.parent.element);
$(_476.element).css({left:_478.width()+1/rabbit.facade.getScaleFactor(),top:_478.position().top/rabbit.facade.getScaleFactor()+_477});
};
var _479=function(){
var _47a=$(this.element.parentNode).hasClass("yuimenubaritem");
if(_47a){
_473(this);
$(this.element).on("mouseout",function(_47b){
var to=_47b.target?_47b.target:_47b.toElement;
...
var _47c=_46f(this);
rabbit.facade.raiseEvent(rabbit.events.subMenuShow,_47c[0],_47c[1],rabbit.util.userRole);
};
var _47d=function(){
var _47e=_46f(this);
rabbit.facade.raiseEvent(rabbit.events.subMenuHide,_47e[0],_47e[1],rabbit.util.userRole);
};
return {init:function(){
rabbit.facade.registerOnEvent(rabbit.events.subMenuShow,_465,this);
rabbit.facade.registerOnEvent(rabbit.events.subMenuHide,_46a,this);
},convertMethodIntoFunction:function(_47f){
for(var i=0;i<_47f.length;i++){
var _480=_47f[i].onclick;
if(_480&&_480.fn!=="undefined"){
_480.fn=eval(_480.fn);
_47f[i].classname="interactive-element-highlighter";
}
if(_47f[i].submenu){
var _481=_47f[i].submenu.itemdata;
this.convertMethodIntoFunction(_481);
}
}
},setupMenu:function setupMenu(id,_482,_483){
try{
_482=_482.replace(/:rabbit.result.manager.menuClick,/g,":\"rabbit.result.manager.menuClick\",");
_482=JSON.parse(_482);
this.convertMethodIntoFunction(_482);
var _484;
if(_483=="vertical"){
_484=new YAHOO.widget.Menu(id+"-bar",{itemdata:_482,visible:true,position:"static",hidedelay:750,lazyload:true});
}else{
_484=new YAHOO.widget.MenuBar(id+"-bar",{lazyload:true,autosubmenudisplay:true,showdelay:10,itemdata:_482});
}
_484.render(id+"-menu-container");
_484.show();
_484.domId=id;
_45e.push(_484);
_484.subscribe("show",_479);
_484.subscribe("hide",_47d);
}
catch(e){
console.error(e);
}
...
var _485=rabbit.facade;
return {init:function init(){
_485.registerOnEvent(rabbit.events.radioButtonClicked,this.onClick,this);
...
if(_487[i].type==="radio"){
_486.push(_487[i]);
}
}
return _486;
},onClick:function onClick(_488,_489){
rabbit.facade.markHighlightTouchesAsSuccessful();
console.log("Click to radioButton "+_488);
var _48a=this.getAllRadioButtons();
for(var i=0;i<_48a.length;i++){
var _48b=_48a[i];
var _48c=_48b.getAttribute("id")+"_svgChecked";
var _48d=document.getElementById(_48c);
if(_48d!=null){
if(!_48b.checked){
if(rabbit.facade.vml){
_48d.style.setAttribute("display","none");
}else{
_48d.setAttribute("visibility","hidden");
}
}else{
if(rabbit.facade.vml){
_48d.style.removeAttribute("display");
}else{
_48d.setAttribute("visibility","inherit");
}
}
}
}
...
var _48e={};
var _48f=function(_490,_491,_492){
var _493=_48e[_490];
if(!_493){
return;
}
if(_492!=null&&_492!=rabbit.util.userRole){
console.log("_sliderChangedCallback "+_491);
_493.setValue(_491);
}
};
return {init:function init(){
rabbit.facade.registerOnEvent(rabbit.events.sliderChangedEvent,_48f,this);
},setupSlider:function(id,_494,_495,_496,_497){
try{
_494=parseInt(_494);
_496=parseInt(_496);
if(_497){
_497=parseInt(_497)*2;
}else{
_497=0;
}
var _498=(_496-(_496)/21)/10;
var _499=_498*_494;
var _49a=_496-_499;
var _49b=null;
if(_495=="vertical"){
_49b=YAHOO.widget.Slider.getVertSlider(id,id+"_thumb_vert",_49a,_499,_498);
}else{
_49b=YAHOO.widget.Slider.getHorizSlider(id,id+"_thumb_horiz",_49a,_499,_498);
}
_48e[id]=_49b;
_49b.animate=false;
_49b.subscribe("change",function(){
var _49c=Math.round(this.getValue()+_497);
rabbit.facade.raiseEvent(rabbit.events.sliderChangedEvent,id,_49c,rabbit.util.userRole);
});
}
catch(e){
console.error(e);
...
var _49d=rabbit.facade;
var _49e=function _49e(_49f,_4a0){
var node=document.getElementById(_49f);
if(node){
node.style.setProperty("fill",_4a0,"");
}
};
var _4a1=function _4a1(_4a2,_4a3){
var _4a4,node=document.getElementById(_4a2);
if(node){
if(_4a3=="url(#sketchedHover)"){
_4a4=node.ownerDocument.createElement("v:fill");
_4a4.setAttribute("src",rabbit.common.baseUrl+"result/icons/sketchedFilledButton.png");
_4a4.setAttribute("type","tile");
_4a4.setAttribute("origin","0.1,0.1");
_4a4.setAttribute("size","175pt,75pt");
_4a4.setAttribute("on","true");
node.getElementsByTagName("fill")[0].parentNode.replaceChild(_4a4,node.getElementsByTagName("fill")[0]);
}else{
_4a4=node.ownerDocument.createElement("v:fill");
_4a4.setAttribute("color",_4a3);
_4a4.setAttribute("on"," true");
node.getElementsByTagName("fill")[0].parentNode.replaceChild(_4a4,node.getElementsByTagName("fill")[0]);
}
}
...
return {init:function init(){
_49d.registerOnEvent(rabbit.events.svgFocus,this.onSvgFocus,this);
_49d.registerOnEvent(rabbit.events.svgBlur,this.onSvgBlur,this);
_49d.registerOnEvent(rabbit.events.propertyChange,this.onPropertyChanged,this);
},setFill:function setFill(id,_4a5){
if(rabbit.facade.vml){
_4a1(id,_4a5);
}else{
_49e(id,_4a5);
}
},onSvgFocus:function onSvgFocus(_4a6){
var _4a7;
if(_4a6 instanceof Array){
for(var key in _4a6){
_4a7=document.getElementById(_4a6[key]);
if(_4a7!=null){
_4a7.setAttribute("class","svg_selected_element");
}
}
}else{
_4a7=document.getElementById(_4a6);
if(_4a7!=null){
_4a7.setAttribute("class","svg_selected_element");
}
}
},onSvgBlur:function onSvgBlur(_4a8){
var _4a9;
if(_4a8 instanceof Array){
for(var key in _4a8){
_4a9=document.getElementById(_4a8[key]);
if(_4a9!=null){
_4a9.setAttribute("class","svg_unselected_element");
}
}
}else{
_4a9=document.getElementById(_4a8);
if(_4a9!=null){
_4a9.setAttribute("class","svg_unselected_element");
}
}
},onPropertyChanged:function onPropertyChanged(_4aa,_4ab){
var _4ac=document.getElementById(_4ab);
if(_4ac==null){
return true;
}
console.debug("Property changed on "+_4aa);
if(event.srcElement[event.propertyName]==false){
_4ac.style.setAttribute("display","none");
}else{
_4ac.style.removeAttribute("display");
}
return true;
}};
}();
...
var _4ad=rabbit.facade;
var _4ae=function _4ae(_4af,_4b0){
var node=document.getElementById(_4af);
if(node){
node.style.setProperty("fill",_4b0,"");
}
};
var _4b1=function _4b1(_4b2,_4b3){
var _4b4,node=document.getElementById(_4b2);
if(node){
if(_4b3=="url(#sketchedHover)"){
_4b4=node.ownerDocument.createElement("v:fill");
_4b4.setAttribute("src",rabbit.common.baseUrl+"result/icons/sketchedFilledButton.png");
_4b4.setAttribute("type","tile");
_4b4.setAttribute("origin","0.1,0.1");
_4b4.setAttribute("size","175pt,75pt");
_4b4.setAttribute("on","true");
node.getElementsByTagName("fill")[0].parentNode.replaceChild(_4b4,node.getElementsByTagName("fill")[0]);
}else{
_4b4=node.ownerDocument.createElement("v:fill");
_4b4.setAttribute("color",_4b3);
_4b4.setAttribute("on"," true");
node.getElementsByTagName("fill")[0].parentNode.replaceChild(_4b4,node.getElementsByTagName("fill")[0]);
}
}
...
return {init:function init(){
_4ad.registerOnEvent(rabbit.events.tabButtonMouseOver,this.handleMouseOver,this);
_4ad.registerOnEvent(rabbit.events.tabButtonMouseOut,this.handleMouseOut,this);
_4ad.registerOnEvent(rabbit.events.pageLoaded,this.changeTab,this);
_4ad.registerOnEvent(rabbit.events.pageReady,this.changeTab,this);
this.oldPageId=null;
},changeTab:function(page,_4b5){
var _4b6="";
if(page){
_4b6=page.data.id;
}
if(this.oldPageId===null){
_4b6=_4ad.getCurrentPageId();
}
var _4b7=selectorUtil.getElementsByName("target"+this.oldPageId);
for(var i=0;i<_4b7.length;i++){
rabbit.util.removeClass(_4b7[i],"selected");
}
var _4b7=selectorUtil.getElementsByName("target"+_4b6);
for(var i=0;i<_4b7.length;i++){
rabbit.util.addClass(_4b7[i],"selected");
}
this.oldPageId=_4ad.getCurrentPageId();
...
if(rabbit.vml){
_4b1(id+"_big_path","#EEEEEE");
_4b1(id+"_small_path","#EEEEEE");
}else{
_4ae(id+"_big_path","#EEEEEE");
_4ae(id+"_small_path","#EEEEEE");
}
}
}
catch(e){
...
if(rabbit.vml){
_4b1(id+"_big_path","white");
_4b1(id+"_small_path","white");
}else{
_4ae(id+"_big_path","white");
_4ae(id+"_small_path","white");
}
}
}
catch(e){
...
var _4b8=0;
var _4b9=".togglesection-header";
var _4ba=".togglesection-content";
var _4bb="content";
var _4bc="#borderDiv";
var _4bd="open";
var _4be=rabbit.facade;
var _4bf=function(_4c0,_4c1){
$("#"+_4c0+_4bb).find(".iframe").css("width",_4c1+"px");
};
return {togglers:{},init:function init(){
rabbit.facade.registerOnEvent(rabbit.events.pageLoaded,this.pageLoaded,this);
rabbit.facade.registerOnEvent(rabbit.events.toggleToggleSection,this.toggle,this);
},setupToggler:function(id,_4c2,_4c3){
this.togglers[id]={id:id,page:_4c2};
$("#"+id).find(_4b9).click(function(){
rabbit.facade.markHighlightTouchesAsSuccessful();
rabbit.facade.raiseEvent(rabbit.events.toggleToggleSection,id);
});
$(_4bc).append($("#"+id).find(_4ba));
},pageLoaded:function(_4c4){
for(var _4c5 in this.togglers){
$("#"+this.togglers[_4c5].id+_4bb).hide();
}
},toggle:function(_4c6){
var _4c7=$("#"+_4c6+">div").data("iframe-url");
$("#"+_4c6+_4bb).slideToggle(_4b8,function(){
$("#"+_4c6).toggleClass(_4bd);
});
}};
}();
...
var _4c8=rabbit.facade;
return {init:function init(){
_4c8.registerOnEvent(rabbit.events.iphoneSwitchClicked,this.onClick,this);
},onClick:function onClick(id){
rabbit.facade.markHighlightTouchesAsSuccessful();
var _4c9=$("#"+id+" .stencil-wrapper > div");
var _4ca=rabbit.events.switchOffSwitch;
_4c9.toggleClass("switch-selected");
if(_4c9.hasClass("switch-selected")){
_4ca=rabbit.events.switchOnSwitch;
}
_4c8.raiseEvent(_4ca,id);
}};
}();
...
var _4cb="rating_white.png";
var _4cc="rating_black.png";
var _4cd=rabbit.facade;
var _4ce=new Array();
var _4cf=function(id){
if(_4ce[id]){
return parseInt(_4ce[id]);
}
return 0;
};
var _4d0=function(id,_4d1){
_4ce[id]=_4d1;
};
var _4d2=function(id,_4d3){
var i=1;
_4d3=parseInt(_4d3);
while(true){
var _4d4=document.getElementById(id+"-"+i);
if(_4d4==null){
break;
}
var _4d5=_4d4.getAttribute("src");
_4d5=_4d5.substring(0,_4d5.lastIndexOf("/")+1);
if(i>=_4d3+1){
_4d5+=_4cb;
}else{
_4d5+=_4cc;
}
_4d4.setAttribute("src",_4d5);
i++;
}
};
return {init:function init(){
_4cd.registerOnEvent(rabbit.events.ratingResultChangedEvent,this.onClick,this);
_4cd.registerOnEvent(rabbit.events.ratingMouseOut,this.onMouseOut,this);
_4cd.registerOnEvent(rabbit.events.ratingMouseOver,this.onMouseOver,this);
},onLoad:function onLoad(id,_4d6){
_4d0(id,_4d6);
},onClick:function onClick(id,_4d7){
rabbit.facade.markHighlightTouchesAsSuccessful();
_4d0(id,_4d7);
_4d2(id,_4d7);
},onMouseOut:function onMouseOut(id){
_4d2(id,_4cf(id));
},onMouseOver:function onMouseOver(id,_4d8){
_4d2(id,parseInt(_4d8));
},checkMouseOutDiv:function(id,_4d9){
if(_4d9.relatedTarget){
return _4d9.relatedTarget.id.indexOf(id)==-1;
}else{
return _4d9.toElement.id.indexOf(id)==-1;
}
}};
}();
...
},setupTree:function setupMenu(id,_4db){
try{
_4db=_4db.replace(/&quot;/g,"\"");
_4db=JSON.parse(_4db);
this._trees[id]=_4db;
}
catch(e){
console.error(e);
}
},clickCallback:function(_4dc,sth){
var _4dd=document.getElementById(_4dc+"-buttonvline");
var _4de="open";
if(_4dd){
if(_4dd.style.display=="none"){
_4de="closed";
}
if(_4de=="closed"){
_4dd.style.display="";
}else{
_4dd.style.display="none";
}
var elem=document.getElementById(_4dc+"-treeviewnodeid");
...
this.update(_4dc,_4de);
}
}
},scrollCallback:function(id,_4df,_4e0){
var _4e1=document.getElementById(id);
_4e1.scrollTop=_4df;
_4e1.scrollLeft=_4e0;
},update:function(_4e2,_4e3){
this.setStatus(_4e2,_4e3);
this.recalculateLineLengths(_4e2);
},setStatus:function(_4e4,_4e5){
var tree=this.getTree(_4e4);
if(tree){
this.setStatusOnSubtree(this.getTreeName(_4e4),tree,_4e4,_4e5);
}
},setStatusOnSubtree:function(_4e6,tree,_4e7,_4e8){
if(tree){
for(var i=0;i<tree.length;i++){
var node=tree[i];
var _4e9=_4e6+"-"+i;
if(_4e9==_4e7){
node.treeItemType=(_4e8=="closed"?"-":"+");
return true;
}
if(node.subtree){
if(this.setStatusOnSubtree(_4e9,node.subtree,_4e7,_4e8)){
return true;
}
}
}
}
},recalculateLineLengths:function(_4ea){
var tree=this.getTree(_4ea);
if(tree){
var _4eb=this.getTreeName(_4ea);
var _4ec=document.getElementById(_4eb+"-openingvline");
this.traverseTree(_4eb,_4ec,tree,null);
}
},traverseTree:function(_4ed,node,_4ee,_4ef){
var _4f0=false;
if(_4ef===null){
_4ef={0:0,1:0};
_4f0=true;
...
this.traverseTree(_4ed+"-"+i,_4f4,_4f5,_4ef);
_4f2=_4f1+1;
_4f1=_4f1+_4ef[0];
_4f3=_4f3+_4ef[1];
}
...
_4f6=document.getElementById(_4ed+"-openingvline");
}
if(_4f6){
var _4f7=_4f6.parentNode;
_4f7.style.height=""+(_4da*_4f1)+"px";
var _4f8=(_4f2-_4f3)*_4da;
_4f6.style.top=""+_4f8+"px";
}else{
}
if(_4f0||"+"==node.treeItemType){
_4ef[0]=rows+_4f1;
}else{
_4ef[0]=rows;
}
_4ef[1]=rows+_4f3;
},getTree:function(_4f9){
if(_4f9){
var _4fa=this.getTreeName(_4f9);
if(this._trees[_4fa]){
return this._trees[_4fa];
}else{
return null;
}
}
},getTreeName:function(_4fb){
return _4fb.substring(0,_4fb.indexOf("-"));
}};
}();
...
rabbit.common.i18n={translation:{},lang:rabbit.parameters.lang,init:function(_4fd){
this.lang=_4fd.lang;
...
var _500=rabbit.common.i18n.translation[lang][_4ff];
if(_500!==undefined){
return _500;
}
return key;
},tReverse:function(_501){
for(var lang in rabbit.common.i18n.translation){
for(var _502 in rabbit.common.i18n.translation[lang]){
var _503=rabbit.common.i18n.translation[lang][_502];
if(_503==_501){
return _502;
}
}
...
return null;
},tr:function(key,_504){
var _505=this.t(key);
for(var k in _504){
_505=_505.replace(k,_504[k]);
}
return _505;
},translation:{}};
...
rabbit.common.frames={none:{frameBorderLeft:10,frameBorderTop:10},custom:{sideMinLength:50,custom:{frameBorderLeft:56.3,frameBorderTop:56.3}},smartphone:{name:t("plugins.frames.smartphone.name"),key:"smartphone",landscape:{frameBorderLeft:124,frameBorderTop:31,innerWidth:640,innerHeight:360,defaultGrid:{numberOfColumns:4,maxWidth:640,gutterWidth:8,marginWidth:16}},portrait:{frameBorderLeft:38,frameBorderTop:124,innerWidth:360,innerHeight:640,defaultGrid:{numberOfColumns:4,maxWidth:360,gutterWidth:8,marginWidth:16}}},android7:{name:t("plugins.frames.android7.name"),key:"android7",landscape:{frameBorderLeft:139,frameBorderTop:59,innerWidth:1024,innerHeight:600,defaultGrid:{numberOfColumns:12,maxWidth:1024,gutterWidth:16,marginWidth:16}},portrait:{frameBorderLeft:58,frameBorderTop:138,innerWidth:600,innerHeight:1024,defaultGrid:{numberOfColumns:12,maxWidth:600,gutterWidth:16,marginWidth:20}}},ipad:{name:t("plugins.frames.ipad.name"),key:"ipad",landscape:{frameBorderLeft:148,frameBorderTop:59,innerWidth:1024,innerHeight:768,defaultGrid:{numberOfColumns:12,maxWidth:1024,gutterWidth:8,marginWidth:18}},portrait:{frameBorderLeft:56,frameBorderTop:148,innerWidth:768,innerHeight:1024,defaultGrid:{numberOfColumns:12,maxWidth:768,gutterWidth:8,marginWidth:16}}},android10:{name:t("plugins.frames.android10.name"),key:"android10",landscape:{frameBorderLeft:169,frameBorderTop:46,innerWidth:1280,innerHeight:800,defaultGrid:{numberOfColumns:12,maxWidth:1280,gutterWidth:16,marginWidth:18}},portrait:{frameBorderLeft:46,frameBorderTop:168,innerWidth:800,innerHeight:1280,defaultGrid:{numberOfColumns:12,maxWidth:800,gutterWidth:16,marginWidth:18}}},browser:{name:t("plugins.frames.browser.name"),key:"browser",landscape:{frameBorderLeft:18,frameBorderTop:52,innerWidth:1366,innerHeight:660,defaultGrid:{numberOfColumns:12,maxWidth:960,gutterWidth:30,marginWidth:15}}},desktop:{name:t("plugins.frames.desktop.name"),key:"desktop",landscape:{frameBorderLeft:57,frameBorderTop:68,innerWidth:1366,innerHeight:768,defaultGrid:{numberOfColumns:12,maxWidth:1200,gutterWidth:30,marginWidth:15}}},getInnerWidth:function(_506,_507){
if(rabbit.common.frames[_506]&&rabbit.common.frames[_506][_507]){
return rabbit.common.frames[_506][_507].innerWidth;
}
return null;
},getFirstMatchedFrame:function(_508,_509){
if(_508||_509){
for(var _50a in this){
if(this[_50a].landscape&&this[_50a].landscape.innerWidth==_508&&this[_50a].landscape.innerHeight==_509){
return {frame:_50a,orientation:"landscape"};
}else{
if(this[_50a].portrait&&this[_50a].portrait.innerWidth==_508&&this[_50a].portrait.innerHeight==_509){
return {frame:_50a,orientation:"portrait"};
}
}
}
}
return {frame:"custom",orientation:"custom"};
},adjusteCustomFrame:function(_50b,_50c){
var _50d=56.3;
var _50e=103;
var _50f=9;
document.querySelector(".corner-top-right").setAttribute("transform","translate("+(_50b+_50f)+", 0)");
document.querySelector(".corner-bottom-left").setAttribute("transform","translate(0, "+(_50c+_50f)+")");
document.querySelector(".corner-bottom-right").setAttribute("transform","translate("+(_50b+_50f)+", "+(_50c+_50f)+")");
document.querySelector(".side-left").setAttribute("width",Math.max(_50d,0));
document.querySelector(".side-left").setAttribute("height",Math.max(_50c-_50e+_50f,0));
document.querySelector(".side-left").setAttribute("transform","translate(0, "+_50e+")");
document.querySelector(".side-top").setAttribute("width",Math.max(_50b-_50e+_50f,0));
document.querySelector(".side-top").setAttribute("height",Math.max(_50d,0));
document.querySelector(".side-top").setAttribute("transform","translate("+_50e+", 0)");
document.querySelector(".side-right").setAttribute("width",Math.max(_50d,0));
document.querySelector(".side-right").setAttribute("height",Math.max(_50c-_50e+_50f,0));
document.querySelector(".side-right").setAttribute("transform","translate("+(_50b+_50d-0.4)+", "+_50e+")");
document.querySelector(".side-bottom").setAttribute("width",Math.max(_50b-_50e+_50f,0));
document.querySelector(".side-bottom").setAttribute("height",Math.max(_50d,0));
document.querySelector(".side-bottom").setAttribute("transform","translate("+_50e+", "+(_50c+_50d-0.4)+")");
}};
if(!rabbit.common){
rabbit.common={};
}
...
},registerUserPref:function(key,_510){
this.userDefaults[key]=_510;
},setUserPref:function(key,_511){
if(rabbit.parameters.userPrefs[key]!=_511){
rabbit.parameters.userPrefs[key]=_511;
if(!this.doNotUseLocalStorage){
localStorage.setItem(key,JSON.stringify(_511));
}
if(!rabbit.parameters.isAnonymous){
...
var _512=rabbit.parameters.userPrefs[key];
if(!this.doNotUseLocalStorage&&(_512===undefined||_512===null)){
_512=JSON.parse(localStorage.getItem(key));
if(_512!==undefined||_512!==null){
this.setUserPref(key,_512);
}
}
if(_512===undefined||_512===null){
...
},registerPrototypePref:function(key,_513){
this.prototypeDefaults[key]=_513;
},setPrototypePref:function(key,_514){
if(rabbit.parameters.prototypePrefs[key]!=_514){
rabbit.parameters.prototypePrefs[key]=_514;
...
var _515=rabbit.parameters.prototypePrefs[key];
if((_515===undefined)||(_515===null)){
